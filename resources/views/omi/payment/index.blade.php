...
{{--para hacer pruebas con el metodo de pago--}}
    @if($contract->project->id==8305)
        <form id="formPayment" name="formPayment" method="post" action="{{url('processTestPayment')}}" onsubmit="return checkForm();" enctype="multipart/form-data">
            <div class="col-md-6 col-sm-12 col-xs-12 boxPaymentInfo">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group col-md-9">
                        ...
                        <input type="text" id="project_price" onkeyup="checkFieldBack(this);" disabled="disabled" name="project_price" class="form-control" value="{{money_format("%i", $contract->type!="PPA"?$contract->price - $contract->paid:$contract->ppaTotalPrice() - $contract->paid)}}">
                    </div>
                </div>
                <br><br>
                <!-- BILLING BLOCK -->
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 boxPaymentInfo">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group">
                        <input name="cctype" type="radio" value="V" class="lft-field" checked/> <img src="{{ asset('img/payment/ico_visa.jpg') }}" align="absmiddle" class="cardhide V"/>
                        <input name="cctype" type="radio" value="M" class="lft-field"/> <img src="{{ asset('img/payment/ico_mc.jpg') }}" align="absmiddle" class="cardhide M"/>
                        <input name="cctype" type="radio" value="A" class="lft-field"/> <img src="{{ asset('img/payment/ico_amex.jpg') }}" align="absmiddle" class="cardhide A"/>
                        <input name="cctype" type="radio" value="D" class="lft-field"/> <img src="{{ asset('img/payment/ico_disc.jpg') }}" align="absmiddle" class="cardhide D"/>

                        @if($project->echeck)
                            <input name="cctype" type="radio" value="E" class="lft-field isCheck"/> <img src="{{ asset('img/payment/eCheck.png') }}" align="absmiddle" class="cardhide D"/>
                        @endif
                        <input name="cctype" type="radio" value="PP" class="lft-field isPayPal"/> <img src="{{ asset('img/payment/ico_paypal.png') }}" align="absmiddle" class="lft-field paypal cardhide PP"/>
                    </div>
                </div>
                <div class="ccinfo">
                    <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    @else
        <form id="formPayment" name="formPayment" method="post" action="{{url('process')}}" onsubmit="return checkForm();" enctype="multipart/form-data">
            <div class="col-md-6 col-sm-12 col-xs-12 boxPaymentInfo">
                <!-- PROJECT BLOCK -->
                <h2 class="subTitles">Project Information</h2>
                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group col-md-9">
                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                        <input type="text" id="project_price" onkeyup="checkFieldBack(this);" name="project_price" class="form-control" value="{{money_format("%i", $contract->type!="PPA"?$contract->price - $contract->paid:$contract->ppaTotalPrice() - $contract->paid)}}">
                    </div>
                </div>
                {{--poner en la linea del input si no se kiere modificar el precio--}}
                {{--{{$contract->funding==0 && $contract->type!="PPA"?"readonly='readonly'":""}}--}}
                <!-- PROJECT BLOCK -->
                <br><br>
                <!-- BILLING BLOCK -->
                <h2 class="subTitles">Billing Information</h2>
