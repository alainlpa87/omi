<div class="col-md-12  divContract">
    ...
    <table width="100%">
        ...
        @endif
        <tr>
            <td><input type="checkbox" id="plan2" name="plan2" class="plans" data-val="{{$contract->ppaPrices()->plan2}}"> PLAN 2 - UNITED STATES TRADEMARK APPLICATION PROGRAM</td>
            <td>{{money_format('%(#10n', $contract->ppaPrices()->plan2)}}</td>
        </tr>
        <tr>
            <td><input type="checkbox" id="plan3" name="plan3" class="plans" data-val="{{$contract->ppaPrices()->plan3}}"> PLAN 3 - UNITED STATES COPYRIGHT APPLICATION PROGRAM</td>
            <td>{{money_format('%(#10n', $contract->ppaPrices()->plan3)}}</td>
        </tr>
        <tr>
            <td><input type="checkbox" id="plan4" name="plan4" class="plans" data-val="{{$contract->ppaPrices()->plan4}}"> PLAN 4 – PATENT COOPERATION TREATY (HEREINAFTER “PCT”) PROGRAM</td>
        ...
        <tr>
            <td><input type="checkbox" id="plan5" name="plan5" class="plans" data-val="{{$contract->ppaPrices()->plan5}}"> PKG A : </td>
        ...
        <tr>
            <td><input type="checkbox" id="plan6" name="plan6" class="plans" data-val="{{$contract->ppaPrices()->plan6}}"> TM & CR ADD ON : </td>
