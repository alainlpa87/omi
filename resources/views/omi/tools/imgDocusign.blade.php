<div class="col-md-12  divContract">
    ...
    <p class="pTitle"><strong>Inventor’s Marketing Guide Proposal</strong></p>
    <ul class="circle">
        ...
        <li><b>Preliminary Invention Illustration</b></li>
        <li>Conclusion and Recommendation</li>
    </ul>
    <p class="pPrice">Total Price: $<span id="tPrice">{{ $contract->price }}</span></p>
            ...
            <ol>
                ...
                <li>
                    <p class="par1">
                        ...
                        PATENT SERVICES USA.  In the past 10 years, the officers of PATENT SERVICES USA, either individually or collectively, assisted Global Licensing Partnerss in its efforts to
