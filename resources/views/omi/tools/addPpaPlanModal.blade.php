            ...
            <div class="modal-body">
                <div  class="container">
                    <div class="form-group">
                        @if($contract!=null)
                            <form action="{{url("launch/addPlan")}}"  name="formAddPlan" id="formAddPlan" onsubmit="return checkFormAddPlan();" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="contractId" value="{{$contract->id}}">
                                <select class="col-md-4" id="selectPlan" name="selectPlan">
                                    <option value="0">--SELECT PLAN--</option>
                                    @if($contract->type=="PPA" && ($contract->ppapricesplan_id == 1 || $contract->ppapricesplan_id == 2))
