        ...
        <div class="table-responsive">
            <table class="border-normal table" style="margin-bottom: 0px !important;">
                ...
                <tr>
                    ...
                    <td colspan="3" style="border-bottom: 1px solid black;"><p class="mySmall" style="text-align: left;"><b>{{ucwords($client->fname." ".$client->lname)}}</b></p></td>
                </tr><tr>
                    <td colspan="1" class="inner-border"><p class="mySmall">Title </p></td>
                    <td colspan="3" style="border-bottom: 1px solid black;">@if($document == 'poaU') {{strtoupper($pcs->titleofinvention)}} @else {{strtoupper($pcs->titleofinventionD)}} @endif</td>
                </tr><tr>
        ...
        <div style="border: 2px solid black;">
            ...
            <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
                ...
                <p class="pSmall" style="margin-bottom: 0px !important;padding: 0px !important;">
                    ...
                    <textarea style="width: 100px !important;height: 30px !important;margin-left: 10px;" disabled="disabled">{{$attorney->customer_number}}</textarea>
                </p>
            ...
            <div style="padding: 0px !important;margin: 0px !important;">
                ...
                <p class="mySmall" style="margin-bottom: 0px !important;padding-bottom: 0px !important;padding-left: 15px !important;">
                    <span><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin-bottom: 0px !important;"> The address associated with  Customer Number: <textarea style="width: 100px !important;height: 30px !important;margin-left: 10px;" disabled="disabled"></textarea></span>
                    <br>
            ...
            <div style="padding: 0px !important;margin: 0px !important;">
                ...
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/chk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Inventor or Joint Inventor </p>
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Legal Representative of a Deceased or Legally Incapacitated Inventor (title not required below) </p>
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Assignee or Person to Whom the Inventor is Under an Obligation to Assign (provide signer’s title if applicant is a juristic entity)</p>
