        ...
        <div style="border: 2px solid black;">
            ...
            <table style="width: 100% !important;border-collapse: collapse !important;">
                <tr>
                    ...
                    <td style="border-bottom: 1px solid black;width: 50% !important;"><p class="superSmall" style="margin: 0px 0px 20px 5px !important;">Patent Number (if applicable):</p></td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid black;border-bottom: 1px solid black;"><p class="superSmall" style="margin: 0px 0px 20px 5px !important;">First Named Inventor:</p></td>
                    <td style="border-bottom: 1px solid black;"><p class="superSmall" style="margin: 0px 0px 20px 5px !important;">Title of Invention:</p></td>
                </tr>
            </table>
            <div style="border-bottom: 1px solid black;">
                ...
                <p class="pSmall" style="margin: 15px 5px 15px 20px !important;">(3) <b>GROSS INCOME LIMIT ON APPLICANTS AND INVENTORS -</b>
                    ...
                    <a href="http://www.uspto.gov/patents/law/micro_entity.jsp" style="color: blue;">http://www.uspto.gov/patents/law/micro_entity.jsp</a> which is equal to three times the median household income for that
                ...
                <p class="pSmall" style="margin: 15px 5px 15px 20px !important;">(4) <b>GROSS INCOME LIMIT ON PARTIES WITH AN “OWNERSHIP
                    ...
                    the “Maximum Qualifying Gross Income” reported on the USPTO website at <a href="http://www.uspto.gov/patents/law/micro_entity.jsp" style="color: blue;">http://www.uspto.gov/patents/law/micro_entity.jsp</a>
