    ...
    <form method="post" action="{{url('launch/clientServices/signed')}}" name="formSign"  id="formSign" >
        ...
        <div class="table-responsive">
            <table class="border-round table" style="border-spacing: 0;">
                ...
                <tr style="padding: 0px;margin: 0px;">
                    ...
                    <td colspan="1" class="inner-border"> <p>Attorney Docket<br> Number</p></td>{{--style="width: 20%;"--}}
                ...
                <tr style="padding: 0px;margin: 0px;">
                    ...
                    <td  style="border-bottom: 1px solid black;"><p style="text-align: center; ">{{ucwords($client->fname." ".$client->lname)}}</p></td>
                </tr>
                <tr style="padding: 0px;margin: 0px;">
        ...
        <div class="col-md-12 col-xs-12 vendorBox" style="border: 2px solid black;">
            <p align="center" style="border: 1px black solid;">
                @if($document=="declarationU")
                    {{strtoupper($pcs->titleofinvention)}}
                @else
                    {{strtoupper($pcs->titleofinventionD)}}
                @endif
            </p>
            ...
            <p class="pSmall"> &nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""> The attached application, </p>
            <p> OR</p>
            <p class="pSmall" style="margin: 0px 0px 10px 10px !important;">&nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt="">
            ...
            <table class="border-normal table" style="padding-bottom: 0px;margin-bottom: 0px;">
                <tr>
                    ...
                    <td style="width: 5%;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;">&nbsp;<img src="{{asset('/img/chk_square.png') }}" alt=""></td>
                    ...
                    <td style="width: 20% !important;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;"><textarea id="cust_number" name="cust_number" rows="1" cols="10" style="width: 100px !important;height: 30px !important;margin: 10px 0px 10px 10px !important;padding: 0px !important;border: 1px solid black;" disabled="disabled">{{$attorney->customer_number}}</textarea></td>
                    <td style="width: 10%;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;">OR &nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""></td>
            ...
            <table class="border-normal table" style="padding-bottom: 0px;margin-bottom: 0px;">
                ...
                <tr>
                    <td style="border-bottom: 1px solid black;" colspan="7">
                        ...
                        <p>{{ucwords($client->fname)." ".ucwords($client->lname)}}</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        ...
                        <p style="margin-top: 0px !important;">{{$client->zip}}</p>
                    </td>
                    <td colspan="2" style="border-bottom: 1px solid black;">
