...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            @endif
        @if($from=="sign")
            <form action="{{url("launch_sandbox/success")}}"  name="formSign" onsubmit="return checkFormSign();" method="post" onsubmit="return checkFormSign();" enctype="multipart/form-data">
                ...
                @elseif($from=="signPPA" || $contract->type=="PPA")
                    <form action="{{url("launch_sandbox/signedPPAContract")}}"  name="formSign" onsubmit="return checkFormSign();" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="ID" value="{{$contract->id}}">
                ...
                @else
                    <form action="{{url("payment")}}"  name="formSign" method="post" onsubmit="return checkFormSign();" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <img src="{{ asset('/img/logos/bbb.png') }}" width="13%" alt="Better Business Bureau" style="margin-right: 5%;">
...
@section('footer_scripts')
    <script src="{{asset("/js/omi/sign_sandbox.js")}}"></script>
@endsection
