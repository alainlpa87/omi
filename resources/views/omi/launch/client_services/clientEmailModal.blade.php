    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <i class="fa fa-paperclip fa-lg pull-left attachFileClientEmail" data-pid="{{$project->id}}" style="cursor: pointer;" id="attachFileClientEmail" data-toggle="tooltip" data-placement="bottom" title="Attach Files"></i>
                <label class="pull-left attachFileClientEmail" data-pid="{{$project->id}}" style="cursor: pointer;" id="labelAttachClientEmail">Add Attachment</label>
                <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
                <button class="btn btn-success" id="sendClientEmail" data-pid="{{$project->id}}">Send</button>
                <br>
