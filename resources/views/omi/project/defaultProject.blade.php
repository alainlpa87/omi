...
<head>
  ...
  ================================================== -->
    ...
    @yield('header_styles')
    <script src="{{ asset('https://html5shim.googlecode.com/svn/trunk/html5.js') }}"></script>
    ...
    <div class="header_style">
        <div class="container-fluid">
            <div class="col-md-4 col-xs-12 logo-blue">
                <img style="vertical-align:text-bottom;" src="{{ asset('img/logos/icologo_lg.png')}}" alt="" width="48">
                PATENT SERVICES
            </div>
            <div class="top-menu">
...
<div class="pre-footer" data-user="" data-pin="">
    ...
    <div class="row">
        ...
        <!-- END BOTTOM CONTACTS -->
        <div class="col-md-12">
            <p class="col-md-6">©2012-2014 PATENT SERVICES. All Rights Reserved.<img class="medalions" src="{{ asset('img/logos/wht_seal.png')}}" alt="Platinum Medalion" width="15%"><a href="https://www.inventpalooza.com/" target="_blank"><img class="medalions" src="{{ asset('img/logos/palooza_200.png')}}" alt="InventPalooza" width="20%"></a></p>
...
<script src="{{asset("js/omi/project.js")}}" type="text/javascript"></script>
