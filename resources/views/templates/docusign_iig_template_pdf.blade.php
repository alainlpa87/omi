...
<br>
<h3><strong>@if(isset($contract) && $contract->iigUpgrade == 1)Invention Initiative Guide Upgrade Proposal @else Invention Initiative Guide Proposal @endif</strong></h3>
<br>
<ul class="circle">
    <table width="85%">
        <tr>
        ...
        <tr>
            <td width="64%">&nbsp;</td>
            <td width="12%" style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: darkgray;"><strong style="margin-left: 20px">SILVER<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{money_format('%.0n', $prices->plan1)}}</strong></td>
            <td width="12%" style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: #FAEFA6;"><strong style="margin-left: 35px">GOLD<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{money_format('%.0n', $prices->plan2)}}</strong></td>
            <td width="12%" style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: #ddd;"><strong style="margin-left: 20px">PLATINUM<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{money_format('%.0n', $prices->plan3)}}</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align:center;vertical-align:middle;background-color: darkgray"><strong style="margin-left: 60%">{{money_format('%.0n', $prices->plan4)}}</strong></td>
            <td style="text-align:center;vertical-align:middle;background-color: #FAEFA6;"><strong style="margin-left: 60%">{{money_format('%.0n', $prices->plan5)}}</strong></td>
            <td style="text-align:center;vertical-align:middle;background-color: #ddd;"><strong style="margin-left: 60%">{{money_format('%.0n', $prices->plan6)}}</strong></td>
        </tr>
        <tr>
            <td width="64%">&nbsp;</td>
            <td width="12%">&nbsp;</td>
        ...
        <tr>
            ...
            <td width="12%"><img src="{{$price == $prices->plan1 ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')}}" style="margin-left: 20px" alt=""> <strong>&nbsp; {{money_format('%.0n', $prices->plan1)}}</strong></td>
            <td width="12%"><img src="{{$price == $prices->plan2 ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')}}" style="margin-left: 20px" alt=""> <strong>&nbsp; {{money_format('%.0n', $prices->plan2)}}</strong></td>
            <td width="12%"><img src="{{$price == $prices->plan3 ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')}}" style="margin-left: 30%" alt=""> <strong>&nbsp; {{money_format('%.0n', $prices->plan3)}}</strong></td>
        </tr>
    </table>
</ul>
...
<p>
    1. This proposal is made between PATENT SERVICES USA, Inc. (PATENT SERVICES) and all Inventors named herewith (The Inventor) in order
...
<p>
    2. This agreement does not execute a patent application, does not provide patent protection of any kind
...
<p>
    3. Invention and new product innovation involves a high degree of risk.  Inventor agrees that a
...
<p>
    4. This Invention Initiative Guide Proposal represents the entire agreement between all parties, whether written, verbal,
...
<p>
    5. The Inventor shall not, nor shall attempt to circumvent or bypass the activities of PATENT SERVICES by negotiating
...
<p>
    6. The Inventor acknowledges PATENT SERVICES does not engage in the business of invention development or marketing services.
...
<p>
    7. All disputes concerning the understanding, meaning or interpretation of any and all parts of this agreement,
...
<p>
    8. All information contained in this and all other documents are proprietary and the exclusive property of PATENT SERVICES, which reserves all rights.  All proprietary information and property is protected
...
{{--Page #3--}}
<p>
    10. The Invention Initiative Guide contains a Market Analysis which may result in a negative outcome.  The Inventor has
