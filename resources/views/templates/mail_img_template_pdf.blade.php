...
<ul class="ul14">
    ...
    <li>
        ...
        <ul class="chk_square">
            <li><img src="{{asset('/img/contracts/check.jpg')}}">Social Factors</li>
            <li><img src="{{asset('/img/contracts/check.jpg')}}">Business Risk Factors</li>
            <li><img src="{{asset('/img/contracts/check.jpg')}}">Demand Analysis Factors</li>
            <li><img src="{{asset('/img/contracts/check.jpg')}}">Market Acceptance Factors</li>
            <li><img src="{{asset('/img/contracts/check.jpg')}}">Competitive Factors</li>
        </ul>
    </li>
...
<table cellspacing="7" align="center" class="rect">
    ...
    <tr>
        <td><img src="{{asset('/img/chk_square.png')}}"> Visa / MasterCard</td>
        <td><img src="{{asset('/img/chk_square.png')}}"> American Express</td>
        <td><img src="{{asset('/img/chk_square.png')}}"> Discover</td>
    </tr>
    <tr>
...
<table class="notesTable">
    <tr>
        <td><img src="{{asset('/img/contracts/unchk_square.png')}}" alt="">  ALL INFORMATION IS CORRECT AND NO CORRECTIONS ARE NECESSARY AT THIS TIME</td>
    </tr>
</table>
...
<table cellspacing="12">
    <tr>
        <td>INVENTOR NAME: {{$project->lead->fname." ".$project->lead->lname}} </td>
        <td>FILE NUMBER: {{$project->lead->fileno}}</td>
    </tr>
    <tr>
