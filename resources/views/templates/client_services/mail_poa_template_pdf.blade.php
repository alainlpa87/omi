...
<table class="border-normal" style="margin-bottom: 0px !important;">
    ...
    <tr>
        ...
        <td colspan="2" class="inner-border">
            @if($coInvIndex==0)
                <img src="{{asset('files/projects/'.$fileno.'/signature_poa.jpg')}}">
            @else
                <img src="{{asset('files/projects/'.$fileno.'/signature_poa_coInv'.$coInvIndex.'.jpg')}}">
            @endif
        </td>
...
<div class="col-md-12" style="border: 2px solid black;">
    ...
    <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
        ...
        <textarea style="position: relative !important;top: -10px !important;margin-bottom: 0px !important;padding: 0px !important;margin-left: 490px !important;width: 100px !important;height: 20px !important; border: 1px solid black !important;">{{$attorney->customer_number}}</textarea>
    ...
    <table class="border-normal">
        ...
        <tr>
            ...
            <td style="width: 40% !important;" class="inner-border">
                @if($coInvIndex==0)
                    <div style="width: 100%; height: 40px"><img src="{{asset('files/projects/'.$fileno.'/signature_poa.jpg')}}"></div>
                @else
                    <div style="width: 100%; height: 40px"><img src="{{asset('files/projects/'.$fileno.'/signature_poa_coInv'.$coInvIndex.'.jpg')}}"></div>
                @endif
            </td>
