...
<table class="border-round" style="border-spacing: 0;">
    ...
    <tr style="padding: 0px;margin: 0px;">
        <td rowspan="3" style="width: 5% !important;padding: 0px !important;margin: 0px !important;" colspan="1">&nbsp; <img src="{{asset('/img/unchk_square.png') }}" alt=""></td>
...
<div class="col-md-12 vendorBox" style="border: 2px solid black;">
    ...
    <p align="left" class="pSmall"> <img src="{{asset('/img/chk_square.png') }}" alt=""> The attached application, </p>
    <p> OR</p>
