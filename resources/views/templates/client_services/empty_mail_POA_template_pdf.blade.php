...
<table class="border-normal" style="margin-bottom: 0px !important;">
    ...
    <tr>
        ...
        <td colspan="3" style="border-bottom: 1px solid black;">{{--$pcs->patentAppNo--}}</td>
    </tr>
    <tr>
        ...
        <td colspan="3" style="border-bottom: 1px solid black;"><p class="mySmall" align="left"><b>{{ucwords($client->fname." ".$client->lname)}}</b></p></td>
    </tr><tr>
        <td colspan="2" class="inner-border"><p class="mySmall">Title </p></td>
        <td colspan="3" style="border-bottom: 1px solid black;">@if($design == 0){{strtoupper($pcs->titleofinvention)}} @else{{strtoupper($pcs->titleofinventionD)}} @endif</td>
    </tr><tr>
        ...
        <td colspan="3" style="border-bottom: 1px solid black;">{{$client->fileno}}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="2" class="inner-border"></td>
    ...
    <tr>
        <td colspan="5"><p class="verySmall"> &nbsp;<img src="{{asset('/img/chk_square.png') }}" alt=""> &nbsp;&nbsp;&nbsp;*Total of <u>&nbsp;&nbsp;{{$coInvCount+1}}&nbsp;&nbsp;</u> forms are submitted.</p></td>
    </tr>
</table>
<p class="superSmall" align="left">This collection of information is required by 37 CFR 1.31, 1.32 and 1.33. The information is required to
...
<p class="superSmall" align="center">If you need assistance in completing the form, call 1-800-PTO-9199 and select option 2. </p>
...
<div class="col-md-12" style="border: 2px solid black;">
    ...
    <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
        ...
        <p style="margin-bottom: 0px !important;padding: 0px !important;font-size: 13px;">
        ...
        <p style="margin:0px 0px 0px 15px !important;padding: 0px !important;font-size: 13px;">and to
        ...
        <textarea class="forced" style="height: 20px !important;">{{$attorney->customer_number}}</textarea>
        <span  style="margin-left:30px !important;margin-bottom: 0px !important;font-size: 13px;">OR</span>
        <p style="margin-bottom: 0px !important;padding: 0px !important;margin-top: 0px !important;font-size: 13px;">
        ...
        <p style="margin:0px 0px 0px 27px !important;padding: 0px !important;font-size: 13px;">
    ...
    <div style="padding: 0px !important;margin: 0px !important;">
        <p  style="margin-top: 0px !important;font-size: 12px;">Please recognize or change the correspondence address for the application identified in the attached transmittal letter or the boxes above to: </p>
        <p  style="padding-left: 15px !important;font-size: 12px;">
            <img src="{{asset('/img/chk_square.png') }}" alt=""> The address associated with the above-mentioned Customer Number.<br>
            <b style="font-size: 12px;">OR</b>
        </p>
        <p style="margin-bottom: 0px !important;padding-bottom: 0px !important;padding-left: 15px !important;font-size: 12px;">
            <img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin-bottom: 0px !important;"> The address associated with  Customer Number:<br>
            <b style="margin-bottom: 0px !important;padding-bottom: 0px !important;font-size: 12px;">OR</b>
            <textarea style="position: relative !important;top: -40px;margin-left: 285px !important;
            width: 100px !important;height: 20px !important;padding: 0px;margin-bottom: 0px !important;"></textarea>
        </p>
    </div>
    ...
    <div style="padding: 0px !important;margin: 0px !important;">
        ...
        <p class="superSmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/chk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Inventor or Joint Inventor (title no required below)</p>
        <p class="superSmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Legal Representative of a Deceased or Legally Incapacitated Inventor (title not required below)</p>
        <p class="superSmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Assignee or Person to Whom the Inventor is Under an Obligation to Assign (provide signer’s title if applicant is a juristic entity)</p>
        <p class="superSmall" style="margin-left: 15px !important;margin-bottom: 0px !important;padding-right: 10px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="" style="margin: 0px !important;">&nbsp;Person Who Otherwise Shows Sufficient Proprietary Interest (e.g., a petition under 37 CFR 1.46(b)(2) was granted in the</p>
    ...
    <table class="border-normal">
        ...
        <tr>
            ...
            <td style="width: 40% !important;" class="inner-border"></td>
        ...
        <tr>
            ...
            <td class="inner-border"><p class="mySmall" align="left"><b>{{ucwords($invName)}}</b></p></td>
    ...
    <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
        <p style="font-size: 11px;padding:0px !important;margin: 0px 0px 0px 10px !important;"><u style="font-size: 11px !important;">NOTE:</u> Signature - This form must be signed by the applicant in accordance with 37 CFR 1.33. See 37 CFR 1.4 for signature requirements and certifications. If more than one applicant, use multiple forms. </p>
    </div>
    <div style="width: 100%;margin: 0px !important;">
        <p style="font-size: 11px;padding:0px !important;margin: 0px 0px 2px 10px !important;"><img src="{{asset('/img/chk_square.png') }}" alt=""> &nbsp;&nbsp;&nbsp;*Total of <u>&nbsp;&nbsp;{{$coInvCount+1}}&nbsp;&nbsp;</u> forms are submitted.</p>
    </div>
</div>
