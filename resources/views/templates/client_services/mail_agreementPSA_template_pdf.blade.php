...
<!--page 1-->
<p align="center" class="title">Agreement for Patent Services</p>
<p class="verySmall">
    This Agreement for Patent Services (the "Agreement") is entered into by and between <u>&nbsp;&nbsp;&nbsp;&nbsp;{{$attorney->fname." ".$attorney->lname}}  &nbsp;&nbsp;&nbsp;&nbsp;</u> (“PATENT FIRM”) and <strong><u class="verySmall">{{ucwords($client->fname." ".$client->lname)}}</u>
        @if(strlen($project->coInventor)!=0)
            and <u class="verySmall">{{$project->coInventor}}</u>
        @endif
    </strong> residing at the address of <strong><u class="verySmall">{{isset($client->street)?$client->street." ".$client->street2:"address"}}</u></strong> ("INVENTOR").  By executing this
...
<p><strong><u class="verySmall">1. Scope of Professional Services-</u></strong></p>
<p class="verySmall">
...
<p><strong><u  class="verySmall">AGENTS OF INVENTOR</u></strong></p>
<p class="verySmall">
    ...
    to PATENT FIRM by AGENT are specially arranged flat-fees for specifically procured patent services as SET ON PAGE THREE, which flat fees are earned
...
<p><strong><u  class="verySmall">2. Other INVENTOR's; Conflicts.</u></strong></p>
<p class="verySmall">
...
<p class="verySmall">
    Patent Services USA frequently retain the above counsel for patent related services and has an ongoing business relationship with this law firm, we provide these attorneys substantial amount of work. However, pursuant to attorney code of ethics our patent attorneys are required to use their own judgment and should not be influenced by the amount of work that is provided to them by Patent Services USA.
</p>
<p class="verySmall">
    You should feel free to confirm with the patent attorney handling your work that they are exercising independent legal judgment.
</p>
<p class="verySmall">
    By signing this letter of engagement, you consent to and waive any potential conflict that could arise the law firm representation and ongoing business relationship with Patent Services USA. This expressly includes the fact that law firm’s personal financial interest creates a potential conflict.
</p>
<p class="verySmall">
...
<p ><strong><u  class="verySmall">3. Confidentiality</u></strong></p>
<p class="verySmall">
...
<p class="verySmall">Moreover, no information shall be considered confidential or property unless INVENTOR marks any such written material "CONFIDENTIAL". If
    ...
    INVENTOR in writing, knowingly use such information and materials for any purpose other than the use contemplated hereby.
</p>
<p class="myOtherFooter verySmall">INVENTOR initials:&nbsp;&nbsp;&nbsp;<u>{{strtoupper($client->fname[0])}}</u>/<u>{{strtoupper($client->lname[0])}}</u> &nbsp;&nbsp;&nbsp; date:<u>&nbsp;&nbsp;&nbsp;{{date('m-d-Y')}}&nbsp;&nbsp;&nbsp;</u></p>
<div class="page-break"></div>
<!--page 2-->
<p class="verySmall">
    PATENT FIRM will use all reasonable diligence to prevent unauthorized use or disclosure by PATENT FIRM of such confidential information; provided, that
...
<p><strong><u class="verySmall">4. General Notices</u></strong></p>
<p class="verySmall">
...
<div class="page-break"></div>
<!--page 3-->
<p class="verySmall">but are not limited to: INVENTOR's invention that is the subject of a PPA or non-provisional patent application was (a) sold or
    ...
    United States more than one year prior to filing.</p>
<p class="verySmall"><b>BY LAW YOU MUST DO THE FOLLOWING OR RISK ANY FUTURE RELATED PATENT BECOMING INVALID:</b>
...
<p class="verySmall">
    The AIPLA economic Survey www.aipla.org developed and directed by the Law Practices Management Committee of the American Intellectual Property Law Association (AIPLA) reports the annual income and related professional and demographic characteristics of intellectual property (IP) law attorney and associated patent agent. According to AIPLA 2015 Report the typical charge for US Utility / Design Patents are:
</p>
<ul class="verySmall">
    <li>Median (Average) Fee for drafting a utility Patent Application is seven thousand dollars ($7,000).</li>
    <li>Median (Average) Fee for drafting a Design Patent application is one thousand one hundred forty two ($1,942).</li>
    <li>Median (Average) Fee for to an action (Final or NON-final) for such utility patent application is two thousand dollars ($2,000).</li>
    <li>Median (Average) Fee for an Appeal of a utility patent application is four thousand dollars ($4,000).</li>
    <li>Median (Average) Fee for Issuing an allowed application is six hundred dollars ($600).</li>
    <li>Median (Average) Fee for Provisional Patent Application is four thousand dollars ($4,000).</li>
</ul>
<p class="verySmall">
    Patent Firm and Patent Services USA have negotiated a fee compensation schedule for IP services. Patent Firm is only able to provide this special reduced rate to Patent Services USA because of the volume of business that they transact with Patent Services USA and this rate is not available to the public. This compensation shall only include Patent Firm fees for professional services for all outsourced IP services as outlined below and does not include any USPTO filling fees and other costs and expenses.
</p>
<ul class="verySmall">
    <li>Fee for drafting a Utility Patent Application is ($800-$1,200).</li>
    <li>Fee for drafting a Design Patent Application is ($250-$500).</li>
    <li>Fee to response to an action (final or NON-final) for such utility or design patent application is ($100-$300).</li>
    <li>Fee to file an Appeal for such utility or design patent application is ($100-$300).</li>
    <li>Fee for all legal work in connection relating to the continuation to final action for such utility or design patent applications is ($100-$300).</li>
    <li>Fee for all legal work in connection with issuance of such utility or design patent application relating to all pending applications is ($100-$300).</li>
    <li>Fee for drafting a provisional patent application is ($200-$500).</li>
    <li>Fee for legal word in connection with trademark research, registration application and prosecution is one ($100-$200).</li>
    <li>Fee for legal work in connection with copyright registration application is ($100-$200).</li>
</ul>
<p class="myOtherFooter verySmall">INVENTOR initials:&nbsp;&nbsp;&nbsp;<u>{{strtoupper($client->fname[0])}}</u>/<u>{{strtoupper($client->lname[0])}}</u> &nbsp;&nbsp;&nbsp; date:<u>&nbsp;&nbsp;&nbsp;{{date('m-d-Y')}}&nbsp;&nbsp;&nbsp;</u></p>
<div class="page-break"></div>
<!--page 4-->
...
<p><strong><u class="verySmall">5.  Termination of PATENT FIRM's Representation</u></strong></p>
<p class="verySmall">
    At the time PATENT FIRM's representation of INVENTOR concludes, all unpaid fees and costs for Patent
...
<p><strong><u class="verySmall">6. Limitation of Liability; Disclaimer of Warranties; Indemnification</u></strong></p>
<p class="verySmall"><strong>TO THE FURTHEST EXTENT PERMITTED UNDER 35 U.S.C. §§1-376 AND ALL RELATED REGULATIONS (THE "PATENT
...
<p><strong><u class="verySmall">7. Necessary Time Deadlines; Disclosure by INVENTOR; INVENTOR Responsibility</u></strong></p>
<p class="verySmall">
...
<p><strong><u class="verySmall">8. Dispute Resolution</u></strong></p>
<p class="verySmall">COOPERATION; CERTAIN INVENTOR CLAIMS:</p>
<p class="verySmall">
...
<p class="verySmall">MEDIATION:</p>
<p class="verySmall">Should the USPTO venue, judgment, or decision that no action will be taken be found to be unenforceable as a matter of
...
<p class="verySmall">ARBITRATION:</p>
<p class="verySmall">All disputes, claims, or controversies arising out of or relating to this Agreement, or any other agreement executed and delivered
...
<p><strong><u class="verySmall">9. Controlling Law</u></strong></p>
<p class="verySmall">The validity, interpretation, and performance of this Agreement will be controlled and construed in all respects under the
    laws of the United States of America and by the laws of the State of {{explode(',',$attorney->location)[1]}}.
</p>
<p><strong><u class="verySmall">10. Miscellaneous</u></strong></p>
<p class="verySmall">INVENTOR acknowledges the importance of informing PATENT FIRM of all relevant facts and cooperating with
    ...
    such property are obligated to promptly enter into, and sign a service agreement to be provided by PATENT FIRM.</p>
<p class="myOtherFooter verySmall">INVENTOR initials:&nbsp;&nbsp;&nbsp;<u>{{strtoupper($client->fname[0])}}</u>/<u>{{strtoupper($client->lname[0])}}</u> &nbsp;&nbsp;&nbsp; date:<u>&nbsp;&nbsp;&nbsp;{{date('m-d-Y')}}&nbsp;&nbsp;&nbsp;</u></p>
<div class="page-break"></div>
<!--page 6-->
<p class="verySmall">
...
<p class="verySmall">This Agreement constitutes the entire agreement between the parties relating to this subject matter and supersedes all
...
<p class="verySmall" style="text-align: center;">I HAVE READ, I UNDERSTAND AND I AGREE TO THE FOREGOING TERMS.</p>
<table style="width: 70%;margin-left:85px !important;">
    <tr>
        <td style="width:300px;"><p class="verySmall">PATENT FIRM</p></td>
        <td style="width:300px;"><p class="verySmall">INVENTOR</p></td>
    </tr>
    <tr>
        <td><p class="verySmall">By:__________________________</p></td>
        <td><img style="position: absolute;top: -8px !important;" src="{{asset('files/projects/'.$fileno.'/signature.jpg')}}"><br><p class="verySmall" style="margin-top: 0px !important;z-index: 100;">By: ___________________</p></td>
    </tr>
    <tr>
        <td><p class="pSmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp;{{ucwords($attorney->fname." ".$attorney->lname)}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p></td>
        <td>
            <p class="verySmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp;{{ucwords($client->fname." ".$client->lname)}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p>
            <p class="verySmall">{{$client->street." ".$client->street2}}</p>
            <p class="verySmall">{{$client->city.", ".$client->state." ".$client->zip}}</p>
            <p class="verySmall">{{$client->phone}}</p>
            <p class="verySmall">{{$client->email}}</p>
        </td>
    </tr>
    @if(strlen($project->coInventor)!=0)
        @for($i=0;$i<count(explode(',',$project->coInventor));$i++)
            <tr>
                <td></td>
                <td><p class="pSmall"><img style="position: absolute;top: -8px !important;" src="{{asset('files/projects/'.$fileno.'/signature_psa'.$i.'.jpg')}}"><br><p class="verySmall" style="margin-top: 0px !important;z-index: 100;">By: ___________________</p></td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <p class="pSmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp;{{explode(',',$project->coInventor)[$i]}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <tr>
        <td>
            <p class="pSmall">Dated:__________________________</p>
        </td>
        <td><p class="verySmall">Dated:<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$month}} - {{$day}} - {{$year}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p></td>
    </tr>
</table>
<p class="myOtherFooter verySmall">INVENTOR initials:&nbsp;&nbsp;&nbsp;<u>{{strtoupper($client->fname[0])}}</u>/<u>{{strtoupper($client->lname[0])}}</u> &nbsp;&nbsp;&nbsp; date:<u>&nbsp;&nbsp;&nbsp;{{date('m-d-Y')}}&nbsp;&nbsp;&nbsp;</u></p>