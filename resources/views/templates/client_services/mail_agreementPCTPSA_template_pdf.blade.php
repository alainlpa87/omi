...
<p class="verySmall">
    This Agreement for Patent Services (the "Agreement") is entered into by and between <u>&nbsp;&nbsp;&nbsp;&nbsp; Ariel S. Bentolila &nbsp;&nbsp;&nbsp;&nbsp;</u> (“PATENT FIRM”) and <strong><u class="verySmall">{{ucwords($client->fname." ".$client->lname)}}</u>
...
<p class="myOtherFooter">INVENTOR initials:&nbsp;&nbsp;&nbsp;<u>{{strtoupper($client->fname[0])}}</u>/<u>{{strtoupper($client->lname[0])}}</u> &nbsp;&nbsp;&nbsp; date:<u>&nbsp;&nbsp;&nbsp;{{date('m-d-Y')}}&nbsp;&nbsp;&nbsp;</u></p>
<div class="page-break"></div>
<!--page 2-->
<ol class="verySmall" type="A" start="3">
...
<p class="verySmall">
    INVENTOR agrees that AGENT or INVENTOR may receive USPTO correspondence and that AGENT shall instruct PATENT FIRM as to the proper
    mailing address to designate. In either case, Agent is the point of contact who will email or FAX any patent office official communication to
    PATENT FIRM for advice and/or proper handler if within the scope of services provided under the agreement. By default, PATENT FIRM will assume
    that correspondence and maintenance fee address may be in AGENT's or INVENTOR's name/address to receive the USPTO correspondence. INVENTOR agrees
    to promptly forward to AGENT all received USPTO correspondence. INVENTOR will also indicate to AGENT each inventor's citizenship if not the US.
    PATENT FIRM will assume all inventors are US citizens unless otherwise indicated.
</p>
<p class="verySmall">
    MAINTENANCE FEES:
</p>
...
<p class="verySmall">Should the USPTO venue, judgment, or decision that no action will be taken be found to be unenforceable as a matter of
    ...
    good faith, settle the dispute through mediation in San Francisco, California conducted by a mediator to be mutually selected. The
...
<p class="verySmall">All disputes, claims, or controversies arising out of or relating to this Agreement, or any other agreement executed and delivered
    ...
    arbitration shall be held in San Francisco, California before a single arbitrator and shall be conducted in accordance with the
    ...
    by the provisions of the California Arbitration Act, California Code of Civil Procedure sections 1280 1294.2. The parties covenant
...
<table style="width: 70%;margin-left:85px !important;">
    ...
    <tr>
        <td><p class="pSmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp; Ariel S. Bentolila&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p></td>
        <td>
