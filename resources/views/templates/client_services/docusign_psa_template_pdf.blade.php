...
<p class="myOtherFooter verySmall">INVENTOR initials: ____________ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date:__________________________</p>
...
<p class="pSmall" style="text-align: center;">I HAVE READ, I UNDERSTAND AND I AGREE TO THE FOREGOING TERMS.</p>
...
<table style="width: 70%;margin-left:85px !important;">
    <tr>
        <td style="width:300px;"><p class="pSmall">PATENT FIRM</p></td>
        <td style="width:300px;"><p class="pSmall">INVENTOR</p></td>
    </tr>
    <tr>
        <td><p class="pSmall">By:  __________________________</p></td>
        <td><p class="pSmall">By:  __________________________</p></td>
    </tr>
    <tr>
        <td><p class="pSmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp;{{ucwords($attorney->fname." ".$attorney->lname)}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p></td>
        <td>
            <p class="pSmall">Print Name: <u>&nbsp;&nbsp;&nbsp;&nbsp;{{ucwords($client->fname." ".$client->lname)}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></p>
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>
            <p style="font-size: 14px !important;margin-bottom: 0px;margin-top: 0px">{{$client->street." ".$client->street2}}&nbsp;</p>
            <p style="font-size: 14px !important;margin-bottom: 0px;margin-top: 0px">{{$client->city.", ".$client->state." ".$client->zip}}&nbsp;</p>
            <p style="font-size: 14px !important;margin-bottom: 0px;margin-top: 0px">{{$client->phone}}&nbsp;</p>
            <p style="font-size: 14px !important;margin-bottom: 0px;margin-top: 0px">{{$client->email}}&nbsp;</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td><p class="pSmall">Date:__________________________</p></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
