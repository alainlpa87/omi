...
<!--page 1-->
    ...
    <p class=" pSmall">
        Owner of Mark (Name): ________<u>{{$ownerMark}}</u>_____________
    </p>
    <p class=" pSmall">
        Country of Citizenship: ________<u>{{$countryCitizenship}}</u>___________
    </p>
    <p class=" pSmall">
        Street Address: _____________<u>{{$address}}</u>___________________
    </p>
    <p class=" pSmall">
        City, State, Zip: ___________<u>{{$cityStateZip}}</u>___________________
    </p>
    <p class=" pSmall">
        Phone Number: _______________<u>{{$phone}}</u>_________________
    </p>
    <p class=" pSmall">
        E-mail Address: _____________<u>{{$email}}</u>___________________
    </p>
    <p class=" pSmall">
        Enter the mark here: _________<u>{{$mark}}</u>__________________
    </p>
    <p class=" pSmall">
        Has the mark been used? _<u>{{$markDate == ''?"No": "Yes"}}</u>_____  Date of first use: {{$markDate == ''?"   N/A": $markDate}}
    </p>
    ...
    <p>___________________<u>{{$descGoods}}</u>______________________________________________</p>
    <p  class=" pSmall" style="margin-bottom: 0px !important;">
    ...
    <p>____________________<u>{{$descMarkUse}}</u>______________________________________________</p>
    <p>
        Attached Specimen?{{$attachedS}}
    </p>
    <p style="margin-bottom: 0px !important;"><strong  class=" pSmall">Description of Specimen:</strong></p>
    <p><u>{{$descSpecimen}}</u></p>
