...
<p class="myOtherFooter">INVENTOR initials: ______/______ &nbsp;&nbsp;&nbsp; date:_______________</p>
...
<table style="width: 70%;margin-left:85px !important;">
    ...
    <tr>
        ...
        <td>
            ...
            <p class="pSmall">{{$client->street." ".$client->street2}}</p>
            <p class="pSmall">{{$client->city.", ".$client->state." ".$client->zip}}</p>
            <p class="pSmall">{{$client->phone}}</p>
            <p class="pSmall">{{$client->email}}</p>
    ...
    @if(strlen($project->coInventor)!=0)
        ...
        <tr>
            <td></td>
            <td>
                <p class="pSmall">{{$project->coInventor}}</p>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td><p class="pSmall">Dated:__________________________</p></td>
    </tr>
</table>
<p class="myOtherFooter">INVENTOR initials: ______/______ &nbsp;&nbsp;&nbsp; date:_______________</p>