<link href="{{ asset('/css/pdf_client.css') }}" rel="stylesheet" xmlns="http://www.w3.org/1999/html">
    ...
    <br>
    <p class=" pSmall">
        Title of the Work: ________<u>{{$titleInput}}</u>____________
    </p>
    <p class=" pSmall">
        Name and address of the Author:
    </p>
    <p class=" pSmall">
        _________<u>{{$nameInput}}</u>_________
    </p>
    <p class=" pSmall">
        _________<u>{{$addressInput}}</u>___________
    </p>
    <br>
    <p class=" pSmall">
        Author's Date of Birth: ______<u>{{$dateOfBirthInput}}</u>___________
    </p>
    <p class=" pSmall">
        Author's Nationality: _________<u>{{$nationalityInput}}</u>____________
    </p>
    <p class=" pSmall">
        Citizen of: _____________<u>{{$citizenInput}}</u>______________
    </p>
    <p class=" pSmall">
        Domiciled in: ____________<u>{{$domiciledInput}}</u>_______________
    </p>
<p class=" pSmall">
    Briefly categorize (literary works, musical works, dramatic works, choreographic works, graphic/sculptural works, audiovisual works, sound recordings, and architectural works) and describe the material created by the author in which copyright is claimed:
</p>
<p><u>{{$categoryInput}}</u></p>
<br><br>
<p class="textRight pSmall" style="width: 100%;">Inventor (s) Initial: <span style="text-decoration: underline;">{{strtoupper($client->fname[0].$client->lname[0])}}</span></p>


<div class="page-break"></div>


<p>Is the Author the Claimant of the copyright? &nbsp;&nbsp;<img src="{{ $claimantRadio == 1 ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> &nbsp;&nbsp;<span class="pMiniSmall">(Yes, unless ownership has been transferred)</span></p>
<p class=" pSmall">Identify any pre-existing material in work:</p>
<p><u>{{$materialsInput}}</u></p>
<p>Deposit Copy Included? &nbsp;&nbsp; <img src="{{ $copyIncludeRadio == 1 ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt="">&nbsp;&nbsp;<span class="pMiniSmall">(A copy of the work typically must be deposited with the U.S. Copyright Office)</span></p>
<br>
<p>
    <strong class=" pSmall">
