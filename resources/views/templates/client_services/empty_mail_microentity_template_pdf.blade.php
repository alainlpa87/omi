...
<div style="border: 2px solid black;">
    ...
    <table style="width: 100% !important;border-collapse: collapse !important;">
        <tr>
            ...
            <td style="border-bottom: 1px solid black;width: 50% !important;"><p class="superSmall" style="margin: 0px 0px 20px 5px !important;">Patent Number (if applicable):</p><span style="margin-top: 0px !important; ">{{--$pcs->patentAppNo--}}</span></td>
        </tr>
        <tr>
            <td style="border-right: 1px solid black;border-bottom: 1px solid black;"><p class="superSmall" style="margin: 0px 0px 0px 5px !important;">First Named Inventor:</p><span style="margin-top: 0px !important; ">{{ucwords($client->fname." ".$client->lname)}}</span></td>
            <td style="border-bottom: 1px solid black;"><p class="superSmall" style="margin: 0px 0px 0px 5px !important;">Title of Invention:</p><span style="margin-top: 0px !important; ">@if($design == 0) {{strtoupper($pcs->titleofinvention)}}@else{{strtoupper($pcs->titleofinventionD)}}@endif</span></td>
        </tr>
    </table>
    <div style="border-bottom: 1px solid black;">
    ...
    <table style="width: 100% !important;border-collapse: collapse !important;">
        ...
        <tr>
            ...
            <td colspan="5" style="border-bottom: 1px solid black;"><p class="mySmall" style="text-align: left;margin-bottom: 3px !important;margin-top: 3px !important;"><b>{{ucwords($invName)}}</b></p></td>
        </tr>
        <tr>
