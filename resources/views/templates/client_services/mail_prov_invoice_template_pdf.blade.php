...
<p class="pSmall">
    <img src="{{$wishNoProv == 1? asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> I do wish to file a non-provisional application related to and before expiration of the provisional
...
<p class="pSmall">
    <img src="{{$understandLose == 1? asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt="">  Understanding that I will lose the rights established by my current pending provisional application,
...
<table width="100%">
    <tr style="margin-bottom: 0px !important;">
        ...
        <td style="margin-bottom: 0px !important;margin-right: 0px !important;">
           <img style="position: absolute;top: -4px !important;" src="{{asset('files/projects/'.$client->fileno.'/signature_provInv_inv.jpg')}}"><br><p style="margin-top: 0px !important;z-index: 100;">_____________________</p>
        </td>
    </tr>
    <tr style="margin-top: 0px !important;">
        ...
        <td style="margin-top: 0px !important;">
            <p style="margin-top: 0px !important;" class="pSmall" >(Inventor name), Inventor</p>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            @if(File::exists('files/projects/'.$client->fileno.'/signature_proInv_coInv.jpg'))
                <img style="position: absolute;top: -4px !important;" src="{{asset('files/projects/'.$client->fileno.'/signature_proInv_coInv.jpg')}}"><br><p style="margin-top: 0px !important;z-index: 100;">_____________________</p>
            @else
    ...
    <tr>
        <td></td>
        <td><p style="margin-top: 0px !important;" class="pSmall" >(Co-Inventor name), Co-Inventor </p></td>
    </tr>
</table>
{{--<p align="right" style="margin-bottom: 0px !important;" class="pSmall" >--}}
    {{--@if(File::exists('files/projects/'.$client->fileno.'/signature_proInv_coInv.jpg'))--}}
        {{--<img src="{{asset('files/projects/'.$client->fileno.'/signature_proInv_coInv.jpg')}}"><br>_____________________--}}
    {{--@else--}}
        {{--____________________________--}}
    {{--@endif--}}
{{--</p>--}}
