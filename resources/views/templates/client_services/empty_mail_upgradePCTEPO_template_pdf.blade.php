...
<p class="pSmall">
    <img src="{{asset('/img/unchk_square.png') }}" alt="" class="halfsize"> &nbsp;&nbsp;<b class="pSmall">PLAN 4</b>- EUROPEAN UNION DESIGN PATENT APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ 7,949
</p>
<p class="pSmall">
...
<p class="pSmall">
    <img src="{{asset('/img/unchk_square.png') }}" alt="" class="halfsize"> &nbsp;&nbsp;<b class="pSmall">PLAN 5</b>-  PATENT COOPERATION TREATY (HEREINAFTER “PCT”) PROGRAM  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ 8,949
</p>
<p class="pSmall">
...
<table width="100%">
    <tr style="margin-bottom: 0px !important;">
        ...
        <td style="margin-bottom: 0px !important;">
            <p align="right" style="margin-bottom: 0px !important;"> ____________________________</p>
        </td>
    </tr>
    <tr style="margin-top: 0px !important;">
        ...
        <td style="margin-top: 0px !important;">
            <p align="right" style="margin-top: 0px !important;">(Inventor name), Inventor</p>
        </td>
    </tr>
</table>
<br>
<p align="right" style="margin-bottom: 0px !important;">____________________________</p>
<p align="right" style="margin-top: 0px !important;">(Co-Inventor name), Co-Inventor </p>
<br><br>
...
{{--<p class="pSmall">Inventor Name:_____________________________________________ File #:______________________________</p>--}}
{{--<p class="pSmall">Credit/debit card:&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""> American Express&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""> MasterCard&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""> Visa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{asset('/img/unchk_square.png') }}" alt=""> Discover Card </p>--}}
{{--<p class="pSmall">Card Number:_______________________________________________  Expiration Date:_____________________</p>--}}
