...
<p class="pSmall">
    ...
    the day of <span class="subTitle">{{((isset($project) && ($project->getProjectProduction() != null) && $project->getProjectProduction()->shippingDate != '0000-00-00 00:00:00'))?date("F jS\, Y",strtotime($project->getProjectProduction()->shippingDate)):date("F jS\, Y")}}</span>
     ("Effective Date") by and between <strong>PATENT SERVICES USA, INC.</strong>, a Florida Corporation
    (hereinafter "Patent Services USA, Inc.") and <span class="subTitle">{{isset($project)?$project->lead->fname." ".$project->lead->lname:"Client's Name"}}</span>
    ...
    <ol class="pSmall" type="none">
        <li>
            ...
            <ol class="pSmall" type="none">
                ...
                <li>
                    <strong>3.1.2. PLAN 2 - UNITED STATES TRADEMARK APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{money_format('%(#10n', $contract->ppaPrices()->plan2)}}</strong>
                    <ol class="pSmall" type="none">
                        <li>
                ...
                <li>
                    <strong>3.1.3. PLAN 3 - UNITED STATES COPYRIGHT APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{money_format('%(#10n', $contract->ppaPrices()->plan3)}}</strong>
                    <ol class="pSmall" type="none">
                        <li>
                ...
                <li>
                    <strong>3.1.4. PLAN 4 – PATENT COOPERATION TREATY <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(HEREINAFTER "PCT") PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{money_format('%(#10n', $contract->ppaPrices()->plan4)}}</strong>
                    <ol class="pSmall" type="none">
                        <p>
        ...
        <p align="center" style="font-size: 15px !important;"><img src="{{asset('/img/unchk_square.png') }}" alt="">&nbsp;<b>PKG A - {{money_format('%(#10n', $contract->ppaPrices()->plan5)}}</b></p>
        ...
        <p align="left" style="font-size: 15px !important;"><b>ADD US TRADEMARK AND US COPYRIGHT APPLICATION PROGRAMS <br>
                TO THE ABOVE PACKAGE &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{money_format('%(#10n', $contract->ppaPrices()->plan6)}}</b></p>
        <br>
        <li>
...
<p style="margin-left: 25%">
    <img src="{{ isset($plans) && $plans[4] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> PKG A &nbsp;
    <img src="{{ isset($plans) && $plans[5] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> TM & CR ADD ON &nbsp;
</p>
