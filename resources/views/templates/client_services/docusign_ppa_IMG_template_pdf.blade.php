...
<p style="margin-left: 25%">
    <img src="{{ $plans[0] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> PLAN 1 &nbsp;
    <img src="{{ $plans[1] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png') }}" alt=""> PLAN 2 &nbsp;
</p>
