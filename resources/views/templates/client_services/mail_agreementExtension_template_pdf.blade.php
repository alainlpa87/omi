...
<br>
<p align="center" style="text-decoration: underline;font-size: 18px;font-weight: bold;">AMENDMENT TO PATENT PROTECTION AGREEMENT</p>
<p class="pSmall">This First Amendment to Patent Protection Agreement (“Amendment”) is made by and between <b>Patent Services
        USA</b> (hereinafter “PATENT SERVICES USA”) and <b>{{ucwords($client->fname." ".$client->lname)}}</b> (hereinafter the “Inventor”).
</p>
<p class="pSmall"><b>WHEREAS</b>, PATENT SERVICES USA and the Inventor entered into that certain Patent Protection Agreement date <b>{{date('m/d/Y',strtotime($pcs->rcvdDate))}}</b>
    the Agreement for patent protection assistance services for <b style="text-decoration: underline">two years</b> (hereinafter the "Invention");and,
</p>
<p class="psmall">
...
<p class="psmall">
    <b>WHEREAS</b>, PATENT SERVICES USA and the inventor now desire to extend the term of the Agreement and provide additional
...
<p class="psmall">&bull;PATENT SERVICES USA and the Inventor hereby extend and renew the terms and conditions of the
    ...
    agreement.</p>
<p class="psmall">&bull;The INVENTOR expressly agrees that the independent registered patent attorney engaged by PATENT
    ...
    client’s file.</p>
<p class="psmall">&bull;All capitalized terms shall have the meaning ascribed to them in the Agreement unless otherwise defined in
    this Amendment.</p>
<br>
...
<p align="right" class="pSmall">Inventor(s) initials: <span style="text-decoration: underline;">{{strtoupper($client->fname[0].$client->lname[0])}}</span>@if($coInvs[0]!='' && ($split = explode(' ',$coInvs[0]))>1)/<span style="text-decoration: underline;">{{strtoupper($split[0][0].$split[1][0])}}</span>@endif</p>
<div class="page-break"></div>
<br><br>
<p class="psmall">&bull;Except as expressly set forth in this Amendment, all other terms and conditions of the Agreement shall
...
<p class="psmall">&bull;Notwithstanding any other provision of this agreement, the INVENTOR expressly agrees that the
...
<p class="psmall"><b>IN WITNESS WHEREOF</b>, the parties execute and make effective this Amendment as of the
...
<table width="100%">
    <tr style="margin-bottom: 0px !important;">
        <td style="margin-bottom: 0px !important;">
            <p><b>PATENT SERVICES USA, INC.</b><br>
                PATENT SERVICES USA Representative:
            </p>
        </td>
        <td style="margin-bottom: 0px !important;">
            <p><b>INVENTOR</b><br>
                Inventor name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">&nbsp;&nbsp;&nbsp;&nbsp;{{ucwords($client->fname." ".$client->lname)}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </p>
        </td>
    </tr>
    <tr style="margin-top: 0px !important;">
        ...
        <td style="margin-top: 0px !important;">
            <img style="position: absolute;top: -7px !important;margin-left: 120px;" src="{{asset('files/projects/'.$pcs->fileno.'/signature.jpg')}}"><br><p style="margin-top: 0px !important;z-index: 100;">Inventor Signature: ______________________</p>
        </td>
    </tr>
    <tr>
        <td style="margin-top: 0px !important;">
            <p style="margin-bottom: 0px !important;">Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{date('m/d/Y')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
        </td>
        <td style="margin-top: 0px !important;">
            <p style="margin-bottom: 0px !important;">Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{date('m/d/Y')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
        </td>
...
@if($coInvs[0]!='')
    <div style="padding-left: 350px;">
        ...
        <p style="margin-top: 15px;"> <img src="{{asset('files/projects/'.$pcs->fileno.'/signatureCoInv.jpg')}}" style="position: absolute;top: -7px !important;margin-left: 120px;"><br><span align="center" style="margin-top: 0px !important;z-index: 100;">Inventor Signature: ________________________</span></p>
        <p >Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{date('m/d/Y')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
    </div>
@endif
<br>
<div style=" position: fixed;bottom: 20px;width: 100%;">
    <p style="font-size:10px;">Disclaimer: PATENT SERVICES is not a law firm and does not provide legal advice or legal opinion.  PATENT SERVICES shall engage an Independent Registered Patent Attorney and/or Patent Agent to assist in certain matters relating to the services described herein. </p>
    <p align="right" class="pSmall">Inventor(s) initials: <span style="text-decoration: underline;">{{strtoupper($client->fname[0].$client->lname[0])}}</span>@if($coInvs[0]!='' && ($split = explode(' ',$coInvs[0]))>1)/<span style="text-decoration: underline;">{{strtoupper($split[0][0].$split[1][0])}}</span>@endif</p>
</div>
