...
<p align="center" class="padd_cover">
    <img src="{{asset('img/ilc_logo.jpg')}}" alt="" name="Object1" width="150" height="116"  align="center">
</p>
...
@if(isset($title1) && $title1 !='')
    ...
    <p class="pSmall" style="text-decoration: underline;font-style: oblique;"><b>{{$title1}}</b></p>
    <p class="pSmall">
        {{$description1}}
        <br>
    <ul>
        @foreach($description11 as $descrp)
            <li style="margin-left: 20px !important;" class="pSmall">{{$descrp}}</li>
        @endforeach
    </ul>
    </p>
    <br><br>
...
@if(isset($title2) && $title2 != '')
    ...
    <p class="pSmall" style="text-decoration: underline;font-style: oblique;"><b>{{$title2}}</b></p>
    <p class="pSmall">
        {{$description2}}
        <br>
    <ul>
        @foreach($description22 as $descrp)
            <li style="margin-left: 20px !important;" class="pSmall">{{$descrp}}</li>
        @endforeach
    </ul>
    </p>
