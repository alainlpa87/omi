...
@if($showMore==1)
    ...
    <p align="center" class="padd_cover">
        <img src="{{asset('/img/logos/logoWithoutBackground.png')}}" alt="" name="Object1" width="245" height="176" id="Object1" align="center">
...
<!--page 5-->
<p align="center" class="padd_cover">
    <img src="{{asset('/img/logos/logoWithoutBackground.png')}}" alt="" name="Object1" width="200" height="140" id="Object1" align="center">
</p>
...
<!--page 7-->
<p align="center" class="padd_cover">
    <img src="{{asset('/img/logos/logoGrey.png')}}" alt="" name="Object1" width="165" height="126" id="Object1" align="center">
    <br><i>Giving the edge to Inventors!</i>
</p>
<p align="center" class="questions">
    <strong>Invention Initiative Guide Agreement</strong>
</p>
<p>Date: {{date("Y-m-d")}}<br>File Number: {{$project->lead->fileno}}</p>
<p>Inventor Name: {{$project->lead->fname." ".$project->lead->lname}}</p>
<p>Invention Title: {{$project->ideaName}}</p>
<p>Dear {{$project->lead->fname}},</p>
<p>This letter is to confirm our receipt of your last payment:</p>
<table  width="100%" cellspacing="10">
    <tr>
        <td> Amount Received: ${{number_format($dataSF['Payment_Amount__c'],2,'.',',')}}</td>
        <td>Amount Paid to Date: {{number_format($dataSF['Amount_Paid_to_Date__c'],2,'.',',')}}</td>
    </tr>
    <tr>
        <td> Payment Received Via: {{$dataSF['Payment_Type__c']}}</td>
        <td>Balance Due: $0.00</td>
    </tr>
</table>
<p>Comments: {{$dataSF['CC_Auth_Code_Comments__c']}}</p>
...
@if($showMore==1)
    ...
    <p>PATENT SERVICES USA refers clients to registered patent attorneys / agents for legal protection. An Independent published sample of 500 clients referred by attorneys for patent and/or trademark services received the following results:</p>
    ...
    <p align="center" class="padd_cover">
        <img src="{{asset('/img/logos/image24.png')}}"  width="100" height="100" id="Object1" align="center">
    </p>
    <p align="center" class="wpSubTitle">
