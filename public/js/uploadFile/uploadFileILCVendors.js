...
var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
    url: "uploadFileILCVendors", // Set the url
    thumbnailWidth: 80,
    thumbnailHeight: 80,
    parallelUploads: 20,
...
myDropzone.on('sending', function(file, xhr, formData){
    ...
    formData.append('IID',currentIlcV.id);
...
myDropzone.on("queuecomplete", function(progress) {
    ...
    ajaxCall({'IID':currentIlcV.id,'PID':getCurrentProject()},'afterUploadFileILCVendor','The file was closed!!','An error has happened, please try later.');
