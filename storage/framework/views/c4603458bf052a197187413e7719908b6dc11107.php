...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('launch_sandbox')); ?>"><i class="fa fa-dashboard "></i>Launch Center</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('launch_sandbox/profile')); ?>"><i class="fa fa-user"></i>Inventor Profile</a>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <?php $__currentLoopData = $client->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($project->status!="EXCLUDE"): ?>
                                    <li>
                                        <a href="<?php echo e(route('launch_sandbox/project',$project->id)); ?>"><i class="fa fa-key "></i><?php echo e($project->ideaName); ?></a>
                                    </li>
                                <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $client->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($project->status!="EXCLUDE"): ?>
                                    <?php if($project->lastContractNoWP() !=null && $project->lastContractNoWP()->paid < $project->lastContractNoWP()->price && in_array($project->stage,array("WOM", 'WALKTHRU',"DROP", "DROP/IMG", "ARCHIVE","PHASE2","CONTRACT")) && ($project->stage=="WALKTHRU"||$project->lastContractNoWP()->type=="IGUP"||$project->lastContractNoWP()->type=="PPA" || new \DateTime($project->actionDate) <= new \DateTime())): ?>
                                        <?php if($project->lastContractNoWP()->funding==1||$project->lastContractNoWP()->type=="PPA"): ?>
                                            <li>
                                                <form method="POST" action="<?php echo e(url("payment_sandbox")); ?>" id="paymentForm_<?php echo e($project->id); ?>">
                                        ...
                                        <?php else: ?>
                                        <li>
                                            <a href="<?php echo e(route('launch_sandbox/signBeforePaid',$project->id)); ?>" class="linkMakePaymentProject" data-id="<?php echo e($project->id); ?>"><i class="fa fa-money"></i><?php echo e($project->ideaName); ?></a>
                                        </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(url('learning')); ?>"><i class="fa fa-lightbulb-o "></i>Learning Center</a>
                    </li>
                   <li>
                        <a href="blank.html"><i class="fa fa-square-o "></i>Settings<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li id="changePass" data-id="<?php echo e($project->lead->id); ?>">
    ...
    <script src="<?php echo e(asset("/js/omi/launch_sandbox.js")); ?>"></script>
