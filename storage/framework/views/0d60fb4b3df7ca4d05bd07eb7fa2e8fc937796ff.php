...
<p >
    Your consultant, <strong><?php echo e($project->consultant->fname." ".$project->consultant->lname); ?></strong>, will be contacting you regularly over the next 3 to 5 weeks to keep you informed
...
<ul class="circle">
    <table width="85%">
        ...
        <tr>
            ...
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 20px" alt=""> <strong>&nbsp; $430</strong></td>
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 20px" alt=""> <strong>&nbsp; $630</strong></td>
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 30%" alt=""> <strong>&nbsp; $930</strong></td>
        </tr>
    </table>
</ul>
<br>
