...
<p class="pSmall">This First Amendment to Patent Protection Agreement (“Amendment”) is made by and between <b>Patent Services
        USA</b> (hereinafter “PATENT SERVICES USA”) and <b><?php echo e(ucwords($client->fname." ".$client->lname)); ?></b> (hereinafter the “Inventor”).
</p>
<p class="pSmall"><b>WHEREAS</b>, PATENT SERVICES USA and the Inventor entered into that certain Patent Protection Agreement date <b><?php echo e(date('m/d/Y',strtotime($pcs->rcvdDate))); ?></b>
...
<p class="psmall">
    ...
    <b><?php echo e(date('m/d/Y',strtotime($pcs->rcvdDate.' +2 years -1 day'))); ?></b> and,
</p>
<p class="psmall">
...
<p align="right" class="pSmall">Inventor(s) initials: ______/______/______</p>
...
<table width="100%">
    ...
    <tr style="margin-top: 0px !important;">
        ...
        <td style="margin-top: 0px !important;">
            <p style="margin-bottom: 0px !important;">Inventor Signature: ________________________</p>
        </td>
    </tr>
    <tr>
        <td style="margin-top: 0px !important;">
            <p align="left" style="margin-bottom: 0px !important;">Date: _______________________</p>
        </td>
        <td style="margin-top: 0px !important;">
            <p style="margin-bottom: 0px !important;">Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;____________________________</p>
        </td>
    </tr>
</table>
<br><br>
<?php if($coInvs[0]!=''): ?>
    <div style="padding-left: 350px;">
        <p >Inventor name: ___________________________</p>
        <p >Inventor Signature: ________________________</p>
