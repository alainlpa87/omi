...
<div class="col-md-12" style="border: 2px solid black;">
    ...
    <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
        ...
        <textarea class="forced" style="height: 20px !important;"><?php echo e($attorney->customer_number); ?></textarea>
    ...
    <table class="border-normal">
        ...
        <tr>
            ...
            <td class="inner-border"><p class="mySmall" align="left"><b><?php echo e(ucwords($invName)); ?></b></p></td>
