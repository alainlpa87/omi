<div class="col-md-12  divContract">
    ...
    <p class="pTitle"><strong>Invention Marketing Guide Upgrade Proposal</strong></p>
    <br>
    <ul class="circle">
        <table width="90%">
            <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: darkgray;"><strong>SILVER<br><?php echo e(money_format('%.0n', $prices->plan1)); ?></strong></td>
                <td style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: #FAEFA6;"><strong>GOLD<br><?php echo e(money_format('%.0n', $prices->plan2)); ?></strong></td>
                <td style="border-bottom: 1px solid;text-align:center;vertical-align:middle;background-color: #ddd;"><strong>PLATINUM<br><?php echo e(money_format('%.0n', $prices->plan3)); ?></strong></td>
            </tr>
            <tr>
...
"></i></li></td>
                <td style="background-color: darkgray;"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #FAEFA6;"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #ddd;"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            </tr>
            <tr>
                <td>
                    <li>
                ...
                <td style="background-color: darkgray;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #FAEFA6;"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #ddd;"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><li><strong>Press Release</strong></li></td>
                <td style="background-color: darkgray;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #FAEFA6;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #ddd;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            </tr>
            <tr>
                <td><li><strong>2D Design</strong></li></td>
                <td style="background-color: darkgray;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #FAEFA6;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #ddd;"><div class="col-md-3 col-md-offset-3"><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            </tr>
            <tr>
                ...
                <td style="text-align:center;vertical-align:middle;background-color: darkgray"><strong><?php echo e(money_format('%.0n', $prices->plan4)); ?></strong></td>
                <td style="text-align:center;vertical-align:middle;background-color: #FAEFA6;"><strong><?php echo e(money_format('%.0n', $prices->plan5)); ?></strong></td>
                <td style="text-align:center;vertical-align:middle;background-color: #ddd;"><strong><?php echo e(money_format('%.0n', $prices->plan6)); ?></strong></td>
            </tr>
            <tr>
                <td width="64%">&nbsp;</td>
                <td width="12%">&nbsp;</td>
            ...
            <tr>
                ...
                <td width="12%" style="text-align:center;vertical-align:middle;"> <?php if($contract->iigUpgrade == 1): ?> &nbsp; <?php else: ?> <input type="checkbox" id="planSilver" checked name="planSilver" class="plansIig" data-val="<?php echo e($prices->plan1); ?>"> <?php endif; ?></td>
                <td width="12%" style="text-align:center;vertical-align:middle;"> <?php if($contract->iigUpgrade == 1 && $contract->paid >= $prices->plan2): ?> &nbsp; <?php else: ?> <?php if($contract->iigUpgrade == 1): ?> <input type="checkbox" id="planGold" name="planGold" class="plansIig" data-val="<?php echo e($prices->plan2); ?>"> <?php else: ?><input type="checkbox" id="planGold" name="planGold" class="plansIig" data-val="<?php echo e($prices->plan2); ?>"> <?php endif; ?> <?php endif; ?></td>
                <td width="12%" style="text-align:center;vertical-align:middle;"><input type="checkbox" id="planPlatinum" name="planPlatinum" class="plansIig" data-val="<?php echo e($prices->plan3); ?>"></td>
            </tr>
        </table>
    </ul>
    <p class="pPrice">Total Price: $<span id="tPrice"><?php echo e($prices->plan1); ?></span></p>
    <input type="hidden" name="hidden_paid" id="hidden_paid" value="<?php echo e($contract->paid); ?>">
    <input type="hidden" name="hidden_iigUpgrade" id="hidden_iigUpgrade" value="<?php echo e($contract->iigUpgrade); ?>">
    ...
    <div class="collapse" id="collapseExample">
        <div class="well">
            <ol>
                <li>
                    <p class="par1">
                        This proposal is made between Patent Services USA and all Inventors named herewith in order to execute this Invention Initiative Guide Proposal (the agreement) for
                        the Invention Initiative Guide outlined on the reverse side of this page.
                    </p>
                </li>
                <li>
                    <p class="par1">
                        This agreement does not execute a patent application, does not provide patent protection of any kind and does not substitute for the legal advice of a registered
                ...
                <li>
                    <p class="par1">
                        New invention innovation and / or product innovation involves a high degree of risk.  Inventor agrees that a patent is the most secure form of legal protection for a
                ...
                <li>
                    <p class="par1">
                        This Invention Initiative Guide represents the entire agreement between all parties, whether written, verbal, expressed or implied.  Any and all other agreements or
                ...
                <li>
                    <p class="par1">
                        The Inventor shall not, nor shall attempt to circumvent or bypass the activities of Patent Services USA by negotiating directly or indirectly with any prospective patent
                ...
                <li>
                    <p class="par1">
                        The Inventor acknowledges Patent Services USA does not engage in the business of invention development or marketing services.  No inventors have received a net
                        ...
                        invention promotion services through Patent Services USA. In the past 10 years, the officers of Patent Services USA, either individually or collectively, assisted
                        Global Licensing Partners in its efforts to research inventions.  Patent Services USA only provides patent assistance services and informational materials related to the
                        invention industry.
                    </p>
                </li>
                <li>
                    <p class="par1">
                        All disputes concerning the understanding, meaning or interpretation of any and all parts of this agreement, including the rights, duties, relationships or obligations of
                ...
                <li>
                    <p class="par1">
                        All information contained in this and all other documents are proprietary and the exclusive property of Patent Services USA, which reserves all rights.  All proprietary
                ...
                <li>
                    <p class="par1">
                        The Invention Initiative Guide contains a Market Analysis which may result in a negative outcome.  All inventors / clients have a seven (7) calendar day right of
