            ...
            <div class="col-md-12 col-xs-12" style="border: 1px solid black;padding-left: 0px !important;padding-right: 0px !important;">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-6 fix-height-2" style="text-align: left;border-right: 1px solid black;padding-left: 0px !important;padding-right: 0px !important;">
                        <p class="superSmall" >First Named Inventor: &nbsp;&nbsp;&nbsp;<?php echo e(ucwords($client->fname." ".$client->lname)); ?></p>
                    </div>
                    <div class="col-md-6 col-xs-6 " >
                        <p class="superSmall" style="text-align: left;">Title of Invention: &nbsp;&nbsp;&nbsp;<?php if($document == 'microEntityD'): ?> <?php echo e(strtoupper($pcs->titleofinventionD)); ?> <?php else: ?> <?php echo e(strtoupper($pcs->titleofinvention)); ?> <?php endif; ?></p>
                    </div>
                </div>
            </div>
            ...
            <table class="table" style="margin-bottom: 0px !important;">
                <tr>
                    <td style="border-right: 1px solid black; margin-left: 20px !important;">
                       <img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin-left: 20px;
                        margin-right: 20px;">
                    </td>
                    <td>
