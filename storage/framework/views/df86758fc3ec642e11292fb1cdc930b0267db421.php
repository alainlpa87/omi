...
<table class="border-round" style="border-spacing: 0;">
    ...
    <tr style="padding: 0px;margin: 0px;">
        ...
        <td colspan="1" class="inner-border"> <p class="mySmall" align="left" style="margin: 0px !important;">Attorney Docket<br> Number</p></td>
    ...
    <tr style="padding: 0px;margin: 0px;">
        ...
        <td  style="border-bottom: 1px solid black;"><p align="left" style="margin: 0px !important;"><?php echo e(ucwords($client->fname." ".$client->lname)); ?></p></td>
    </tr>
    <tr style="padding: 0px;margin: 0px;">
    ...
    <tr style="padding: 0px;margin: 0px;">
        <td rowspan="3" style="width: 5% !important;padding: 0px !important;margin: 0px !important;" colspan="1">&nbsp; <img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""></td>
...
<div class="col-md-12 vendorBox" style="border: 2px solid black;">
    <p align="center" class="pSmall" style="border: 1px black solid;"><?php if($design == 0): ?> <?php echo e(strtoupper($pcs->titleofinvention)); ?><?php else: ?><?php echo e(strtoupper($pcs->titleofinventionD)); ?><?php endif; ?></p>
    <p align="center" class="mySmall" style="padding-top: 0px !important;margin-top: 0px !important;"><i>(Title of the Invention)</i></p>
    <p align="left" class="pSmall" style="margin: 0px 0px 5px 5px !important;">As a below named inventor, I hereby declare that:</p>
    <p align="left" class="pSmall" style="margin: 0px 0px 5px 5px !important;">This declaration is directed to: </p>
    <p align="left" class="pSmall"> <img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""> The attached application, </p>
    <p> OR</p>
    <p align="left" class="pSmall" style="margin: 0px 0px 5px 5px !important;"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="">
    ...
    <table class="border-normal" style="padding-bottom: 0px;margin-bottom: 0px;">
        <tr>
            ...
            <td style="width: 5%;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;"><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt="" style="margin: 0px 0px 10px 10px !important;"></td>
            ...
            <td style="width: 20% !important;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;"><textarea rows="1" cols="10" style="width: 100px !important;height: 30px !important;margin: 10px 0px 10px 10px !important;padding: 0px !important;" disabled="disabled"><?php echo e($attorney->customer_number); ?></textarea></td>
            <td style="width: 10%;margin: 0px !important;padding: 0px !important;border-bottom: 1px solid black;">OR <img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin: 0px 0px 10px 10px;"></td>
...
<table class="border-normal" style="padding-bottom: 0px;margin-bottom: 0px;">
    ...
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="7">
            ...
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e(ucwords($client->fname." ".$client->lname)); ?></p>
        </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;border-right: 1px solid black;" colspan="5"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-top: 0px;margin-top: 0px;">Inventor’s <br>Signature</p></td>
    ...
    <tr>
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
            ...
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e($client->city); ?></p>
        </td>
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
            <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-top: 0px;margin-top: 0px;">State </p>
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e($client->state); ?></p>
        </td>
        <td colspan="3" style="border-bottom: 1px solid black;">
            <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-top: 0px;margin-top: 0px;">Country</p>
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e($client->country); ?></p>
        </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="7">
            <p style="font-size: 13px; padding-top: 0px;margin-top: 0px;margin-left: 0px;padding-left: 0px">Mailing Address</p>
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e($client->street); ?></p>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
            ...
            <p style="margin-bottom: 0px !important;margin-top: 0px !important;"><?php echo e($client->zip); ?></p>
        </td>
    ...
    <tr>
        <td colspan="7">
            <p class="verySmall" style="margin-left: 100px !important;">
                <img src="<?php echo e($sheetsCount == 0 ? asset('/img/unchk_square.png') : asset('/img/chk_square.png')); ?>" alt="">
                &nbsp;&nbsp;&nbsp;Additional inventors are being named on the <u><?php echo e($sheetsCount>0 ? $sheetsCount : "___"); ?></u>
