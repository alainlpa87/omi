<div class="col-md-12  divContract">
    <form method="post" action="<?php echo e(url('launch/clientServices/signed')); ?>" name="formSign"  id="formSign" >
        ...
        <input type="hidden" name="COINV" value="<?php echo e($coInvIndex); ?>">
        <p class="pLogo">
        ...
        <table  style="width: 100%;">
            ...
            <tr >
                ...
                <td colspan="1">
                    <p  class="superSmall pull-right">PTO/AIA/82A (07-13)</p><br>
                    <p  class="superSmall pull-right">Approved for use through 11/30/2014. OMB 0651-0051</p>
                </td>
            </tr>
        ...
        <div class="table-responsive">
            <table class="border-normal table" style="margin-bottom: 0px !important;">
                <tr>
                    <td colspan="4" style="border-bottom: 1px solid black;">
                        <p class="mySmall" style="margin-left: 10px !important;margin-right: 10px !important;">
                            <u>NOTE:</u> This form is to be submitted with the Power of Attorney by Applicant form(PTO/AIA/82B)</p>
                            <p class="mySmall" style="margin-left: 10px !important;margin-right: 10px !important;">
                                o identify the application to which the Power of Attorney is directed, in accordance with 37 CFR 1.5. If the Power
                            </p>
                            <p class="mySmall" style="margin-left: 10px !important;margin-right: 10px !important;">
                                of Attorney by Applicant form is not accompanied by this transmittal form or an equivalent, the Power of
                            </p>
                            <p class="mySmall" style="margin-left: 10px !important;margin-right: 10px !important;">
                                Attorney will not be recognized in the application.
                            </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3" style="border-bottom: 1px solid black;"><p class="mySmall" style="text-align: left;"><b><?php echo e(ucwords($client->fname." ".$client->lname)); ?></b></p></td>
                </tr><tr>
                    <td colspan="1" class="inner-border"><p class="mySmall">Title </p></td>
                    <td colspan="3" style="border-bottom: 1px solid black;"><?php if($document == 'poaU'): ?> <?php echo e(strtoupper($pcs->titleofinvention)); ?> <?php else: ?> <?php echo e(strtoupper($pcs->titleofinventionD)); ?> <?php endif; ?></td>
                </tr><tr>
                ...
                <tr>
                    ...
                    <td colspan="1" class="inner-border" style="width: 10%;"><p class="mySmall">Date(Optional)</p></td>
                    <td colspan="1" style="border-bottom: 1px solid black;width: 30%;"></td>
                </tr>
                <tr>
                    <td colspan="1" class="inner-border"><p class="mySmall">Name </p></td>
                    <td colspan="1" class="inner-border">
                        <p class="mySmall" style="text-align: left">
                            <b>
                                <?php if($coInvIndex==0): ?>
                ...
                <tr>
                    <td colspan="1" class="inner-border"><p class="mySmall">Title (if Applicant is a juristic entity)</td>
                ...
                <tr>
                    <td colspan="4" style="border-bottom: 1px solid black;"><p class="verySmall">NOTE: This form must be signed in accordance with 37 CFR 1.33. See 37 CFR 1.4(d)for signatures requirements and certifications.If more than one applicant, use multiple forms.</p></td>
                </tr>
            </table>
        </div>
        ...
        <div style="border: 2px solid black;">
            <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
                <p style="font-size: 13px;padding:0px !important;margin: 0px 0px 0px 10px !important;">I hereby revoke all previous powers of attorney given in the application identified in either the attached transmittal letter or the boxes below.</p>
            </div>
            <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
                ...
                <p style="text-align: center">(Note: The boxes above may be left blank if information is provided on form PTO/AIA/82A.)</p>
                <p class="pSmall" style="margin-bottom: 0px !important;padding: 0px !important;">
                    ...
                    <textarea style="width: 100px !important;height: 30px !important;margin-left: 10px;" disabled="disabled"><?php echo e($attorney->customer_number); ?></textarea>
                </p>
                ...
                <p class="pSmall" style="margin-bottom: 0px !important;padding: 0px !important;">
                    ...
                    letter (form PTO/AIA/82A) or identified above. (Note: Complete form PTO/AIA/82C.)
                </p>
            </div>
            <div style="padding: 0px !important;margin: 0px !important;">
                ...
                <p class="mySmall" style="margin-bottom: 0px !important;padding-bottom: 0px !important;padding-left: 15px !important;">
                    <span><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin-bottom: 0px !important;"> The address associated with  Customer Number: <textarea style="width: 100px !important;height: 30px !important;margin-left: 10px;" disabled="disabled"></textarea></span>
                    <br>
                    <b class="pSmall" style="margin-bottom: 0px !important;padding-bottom: 0px !important;">OR</b>
                </p>
            </div>
            <div class="table-responsive">
            <table class="border-normal table" style="margin-top: 0px !important;">
                <tr>
                    <td class="inner-border" style="width: 20% !important;">
                        <p class="mySmall" style="padding:3px 0px 0px 15px !important;margin: 0px !important;">
                            <img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin: 0px !important;">
            ...
            <div style="padding: 0px !important;margin: 0px !important;">
                ...
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt="" style="margin: 0px !important;">&nbsp;Inventor or Joint Inventor </p>
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin: 0px !important;">&nbsp;Legal Representative of a Deceased or Legally Incapacitated Inventor (title not required below) </p>
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin: 0px !important;">&nbsp;Assignee or Person to Whom the Inventor is Under an Obligation to Assign (provide signer’s title if applicant is a juristic entity)</p>
                <p class="mySmall" style="margin-left: 15px !important;margin-bottom: 0px !important;padding-right: 10px !important;"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="" style="margin: 0px !important;">&nbsp;Person Who Otherwise Shows Sufficient Proprietary Interest (e.g., a petition under 37 CFR 1.46(b)(2) was granted in the</p>
                <p class="pSmall" style="margin-left: 28px !important;margin-top: 0px !important;margin-bottom: 0px !important;">application or is concurrently being filed with this document (provide signer’s title if applicant is a juristic entity)</p>
            </div>
            <div class="table-responsive">
            <table class="border-normal table">
                ...
                <tr><td colspan="4" style="border-bottom: 1px solid black;"><p class="mySmall">The undersigned (whose title is supplied below) is authorized to act on behalf of the applicant (e.g., where the applicant is a juristic entity).</p></td></tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="inner-border"><p class="nySmall" style="text-align: center;margin-top: 3px !important;margin-bottom: 3px !important;">
                            <b>
                                <?php if($coInvIndex==0): ?>
                                    <?php echo e(ucwords($client->fname." ".$client->lname)); ?>
            ...
            <div style="width: 100%;border-bottom:2px solid black;padding:0px !important;margin: 0px !important;">
                <p style="font-size: 11px;padding:0px !important;margin: 0px 0px 0px 10px !important;">NOTE:</u> Signature - This form must be signed by the applicant in accordance with 37 CFR 1.33. See 37 CFR 1.4 for signature requirements and certifications. If more than one applicant, use multiple forms. </p>
            </div>
        </div>
