...
<table>
    <tr style="margin-bottom: 0px !important;padding-bottom: 0px;">
        ...
        <td colspan="3" style="margin-bottom: 0px !important;padding-bottom: 0px;">
            <p ><?php echo e($attorney->fname." ".$attorney->lname); ?></p>
        </td>
    </tr>
    <tr style="margin-bottom: 0px !important;">
        ...
        <td colspan="3">
            <p  ><?php echo e(str_replace('<br>',', ',$attorney->uuid)); ?></p>
        </td>
    </tr>
    <tr style="margin-bottom: 0px !important;">
        <td colspan="2" >
...
<p class="myOtherFooter">Initials: &nbsp;&nbsp;&nbsp;<u><?php echo e(strtoupper($client->fname[0])); ?></u>/<u><?php echo e(strtoupper($client->lname[0])); ?></u></p>
...
<table>
    ...
    <tr style="margin-bottom: 0px !important;">
        <td>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($client->fname." ".$client->lname); ?>
