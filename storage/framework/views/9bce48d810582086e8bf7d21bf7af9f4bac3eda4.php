...
<!--page 1-->
<?php for($i=0;$i<count($coInvs);$i=$i+3): ?>
...
<table class="border-round">
    <tr>
        ...
        <td style="width: 50%;">
            ...
            <p  align="right" style="padding: 0px;margin: 0px;font-size:12px"> Page <u><?php echo e(round($i/3) + 1); ?></u> of <u><?php echo e(round((count($coInvs)-1)/3) + 1); ?></u></p>
        </td>
    </tr>
</table>
<table class="border-normal">
    ...
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="5">
            ...
            <p><?php echo e($coInvs[$i]); ?></p>
        </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;border-right: 1px solid black;" colspan="4"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;margin-top: 0px;">Inventor’s<br>Signature</p></td>
    ...
    <tr>
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">Residence: City </p></td>
        <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">State </p></td>
        <td colspan="2" style="border-bottom: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">Country</p></td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="5"> <p style="font-size: 13px; padding-bottom: 0px;margin-bottom: 0px;margin-left: 0px;padding-left: 0px"><br>Mailing Address</p></td>
    </tr>
    <tr>
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">City </p></td>
        <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">State </p></td>
        <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">Zip </p></td>
        <td colspan="1" style="border-bottom: 1px solid black;"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">Country </p></td>
    </tr>
    <tr>
        <td colspan="5" style="border-bottom: 1px solid black;padding-top: 10px;"><b style="font-size: 14px;">Legal Name of Additional Joint Inventor, if any: </b> </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="5">
            <p style="font-size: 13px; padding-top: 0px;margin-top: 0px;">(E.g., Given Name (first and middle (if any)) and Family Name or Surname)</p>
            <p><?php if($i+1<count($coInvs)): ?><?php echo e($coInvs[$i+1]); ?><?php endif; ?></p>
        </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;border-right: 1px solid black;" colspan="4"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;margin-top: 0px;">Inventor’s<br>Signature</p></td>
    ...
    <tr>
        <td style="border-bottom: 1px solid black;" colspan="5">
            <p style="font-size: 13px; padding-top: 0px;margin-top: 0px;">(E.g., Given Name (first and middle (if any)) and Family Name or Surname)</p>
            <p><?php if($i+2<count($coInvs)): ?><?php echo e($coInvs[$i+2]); ?><?php endif; ?></p>
        </td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid black;border-right: 1px solid black;" colspan="4"><p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;margin-top: 0px;">Inventor’s<br>Signature</p></td>
