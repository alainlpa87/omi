            ...
            <div class="modal-body">
                <div class="row noTop">
                    <ul class="nav nav-tabs" role="contractActionsTab">
                        <li id="wp_li"><a href="#wp_tab" data-toggle="tab" role="tab"> <?php echo e(WELCOME_PACKAGE); ?> </a></li>
                        <li id="up_li"><a href="#up_tab" data-toggle="tab" role="tab"> <?php echo e(UPGRADE); ?> </a></li>
