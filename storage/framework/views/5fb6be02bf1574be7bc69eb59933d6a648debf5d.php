...
<?php $__env->startSection('metainfo'); ?>
    ...
    <?php else: ?>
        <meta name="description" content="<?php echo e($descriptionhtml); ?>" />
    <?php endif; ?>
...
<?php $__env->startSection('title'); ?>
    ...
    <?php else: ?>
        <?php echo e($titlehtml); ?>

    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('header_styles'); ?>
    <link href="<?php echo e(asset('/css/learning.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <section class="main-section" id="Portfolio" style="padding-top: 30px"><!--main-section-start-->
        <div class="container" id="containerLearning">
            <h2 id="articleTitle"><?php if($title!='none'): ?><?php echo e($title); ?><?php endif; ?></h2>
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 container-tools-left artLinks">
                    <ul>
                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="learningTopic" data-title="<?php echo e($art->title); ?>"><?php echo e($art->title); ?></li>
...
<?php $__env->startSection('footer_scripts'); ?>
    <script src="<?php echo e(asset('/js/omi/newLearning.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
