<div class="col-md-12  divContract">
    ...
    <p class="pTitle"><strong><?php if($contract->iigUpgrade == 1): ?>Invention Initiative Guide Upgrade Proposal <?php else: ?> Invention Initiative Guide Proposal
    ...
    <ul class="circle">
        <table width="90%">
            ...
            <tr>
                ...
                <td style="background-color: darkgray;" align="center"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #FAEFA6;" align="center"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
                <td style="background-color: #ddd;" align="center"><div class="col-md-3 col-md-offset-3" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            </tr>
            <tr>
                <td>
                    <li>
...
"></i></li></td>
            ...
            <tr>
                ...
                <td width="12%" style="text-align:center;vertical-align:middle;"> <?php if($contract->iigUpgrade == 1): ?> &nbsp; <?php else: ?> <input type="checkbox" id="planSilver" name="planSilver" class="plansIig" checked data-val="<?php echo e($prices->plan1); ?>"> <?php endif; ?></td>
    ...
    <?php if($contract->iigUpgrade == 1): ?> <p class="pPrice">Total Price: $<span id="tPrice"></span></p> <?php else: ?> <p class="pPrice">Total Price: $<span id="tPrice"><?php echo e($prices->plan1); ?></span></p> <?php endif; ?>
