...
<br>
<h3><strong><?php if(isset($contract) && $contract->iigUpgrade == 1): ?>Invention Initiative Guide Upgrade Proposal <?php else: ?> Invention Initiative Guide Proposal <?php endif; ?></strong></h3>
<br>
<ul class="circle">
    <table width="85%">
        <tr>
        ...
        <tr>
            ...
            <td style="background-color: darkgray;" align="center"><div class="col-md-3 " style="margin-left: 60%" style="margin-left: 60%" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            <td style="background-color: #FAEFA6;" align="center"><div class="col-md-3 " style="margin-left: 60%" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
            <td style="background-color: #ddd;" align="center"><div class="col-md-3 " style="margin-left: 60%" ><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
        </tr>
        <tr>
            <td>
                <li>
            ...
            <td style="background-color: darkgray;"><div class="col-md-3 " style="margin-left: 60%" style="margin-left: 25%"><img src="<?php echo e(asset('/img/chk_square.png')); ?>" alt=""></div></td>
