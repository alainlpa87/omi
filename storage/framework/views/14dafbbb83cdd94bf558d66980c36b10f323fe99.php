...
<?php if(setlocale(LC_MONETARY, 'en_US')): ?>
<?php endif; ?>
    <!--page 1-->
    <p class="iconMargin">
...
<p class="pSmall">
    ...
    the day of <span class="subTitle"><?php echo e(((isset($project) && ($project->getProjectProduction() != null) && $project->getProjectProduction()->shippingDate != '0000-00-00 00:00:00'))?date("F jS\, Y",strtotime($project->getProjectProduction()->shippingDate)):date("F jS\, Y")); ?></span>
     ("Effective Date") by and between <strong>PATENT SERVICES USA, INC.</strong>, a Florida Corporation
    (hereinafter "Patent Services USA, Inc.") and <span class="subTitle"><?php echo e(isset($project)?$project->lead->fname." ".$project->lead->lname:"Client's Name"); ?></span>
...
<ol class="pSmall">
    <li>
        ...
        <ol class="pSmall" type="none">
            <li>
                <strong>1.1 Various Patent Protection Services.</strong> Patent Services USA, Inc. provides four (4) Patent Protection Plans which are particularly described in Section 3. INVENTOR agrees and acknowledges Patent Services USA, Inc. has provided all necessary disclosures to the INVENTOR as provided under 35 U.S.C. 297 (a) in the Invention Initiative Guide Agreement which has been previously executed by INVENTOR.
            </li>
        </ol>
    </li>
    <li>
    ...
    <ol class="pSmall" type="none">
        <li>
            ...
            <ol class="pSmall" type="none">
                <li>
                    <strong>3.1.1. PLAN 1 – UNITED STATES UTILITY PATENT APPLICATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan1)); ?><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PROGRAM</strong>
                    <ol class="pSmall" type="none">
                        <li>
                ...
                <li>
                    <strong>3.1.2. PLAN 2 - UNITED STATES TRADEMARK APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan2)); ?></strong>
                    <ol class="pSmall" type="none">
                        <li>
                            <strong>3.1.2.1.</strong> Patent Services USA, Inc. will facilitate and coordinate the documentation relating to trademark search by working with the INVENTOR and an independent registered patent attorney or agent. Patent Services USA, Inc. shall pay the United States Trademark filing fee.
                        </li>
                        <li>
                            <strong>3.1.2.2.</strong> Based on the results of the trademark search and upon INVENTOR's approval, Patent Services USA, Inc. will facilitate and coordinate the documentation relating to trademark application with the INVENTOR and an independent attorney.
                        </li>
                        <li>
                ...
                <li>
                    <strong>3.1.3. PLAN 3 - UNITED STATES COPYRIGHT APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan3)); ?></strong>
                    <ol class="pSmall" type="none">
                        <li>
                            <strong>3.1.3.1.</strong> Patent Services USA, Inc. will facilitate and coordinate the documentation relating to copyright search by working with the INVENTOR and an independent registered patent attorney or agent. Patent Services USA, Inc. shall pay the United States Copyright filing fee.
                        </li>
                        <li>
                            <strong>3.1.3.2.</strong> Based on the results of the copyright search and upon INVENTOR's approval, Patent Services USA, Inc. will facilitate and coordinate the documentation relating to copyright application with the INVENTOR and an independent attorney.
                        </li>
                        <li>
                ...
                <li>
                    <strong>3.1.4. PLAN 4 – PATENT COOPERATION TREATY <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(HEREINAFTER "PCT") PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan4)); ?></strong>
                    <ol class="pSmall" type="none">
                        <p>
                        ...
                        <li>
                            <strong>3.1.4.1.</strong> Patent Services USA, Inc. will facilitate and coordinate the necessary documentation by working with the INVENTOR and independent registered patent attorney regarding the PCT application filing. Patent Services USA, Inc. shall pay the PCT application filing fee. Inventor will be responsible to pay the fees to each country from which he or she wishes to receive patent protection.
                        </li>
                        <li>
                            <strong>3.1.4.2.</strong> Patent Services USA, Inc. shall use best efforts to engage an Independent Licensing Affiliate (hereinafter and as defined above, "ILA") to schedule six (6) to eight (8) national and/or international invention trade shows every twelve (12) months for a period of two (2) years, attended by ILA as explained in Exhibit B of this Agreement, which is incorporated herein by reference.
                        </li>
                        <li>
                            <strong>3.1.4.3.</strong> The INVENTOR's invention shall be posted on the website(s) of the ILA for a period of two (2) years, at the sole discretion of the ILA.
                        </li>
                        <li>
                            <strong>3.1.4.4.</strong> Patent Services USA, Inc. shall engage a Computer Animation Specialist who will design a three-dimensional animated prototype video, sell sheet and 3D-printed model (if applicable) for the INVENTOR's invention. This design package will be used by the ILA in connection with rendering the services of ILA as explained in Exhibit A of this Agreement.
                        </li>
                        <li>
                            <strong>3.1.4.5.</strong> Throughout the term of this Agreement, Patent Services USA, Inc. shall provide customer service support to INVENTOR in connection with the progress of its services as stated herein.
                        </li>
                    </ol>
                </li>
            </ol>
        ...
        <p align="center" style="font-size: 15px !important;"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="">&nbsp;<b>PKG A - <?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan5)); ?></b></p>
        <p align="left" style="font-size: 15px !important;"><b>PLAN 1- UNITED STATES UTILITY PATENT APPLICATION PROGRAM</b></p>
        <p align="left" style="font-size: 15px !important;"><b>PLAN 4- PATENT COOPERATION TREATY (HERINAFTER "PCT") PROGRAM</b></p>
        <br>
        ...
        <p align="left" style="font-size: 15px !important;"><b>ADD US TRADEMARK AND US COPYRIGHT APPLICATION PROGRAMS <br>
                TO THE ABOVE PACKAGE &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(money_format('%(#10n', $contract->ppaPrices()->plan6)); ?></b></p>
        <br>
        <li>
    ...
    <li>
        ...
        Due to work scheduling of attorneys, draftsmen, production personnel and other factors beyond any control, Patent Services USA, Inc. 
		reserves the first right to refuse all refund requests after the three (3) calendar day rescission period stated above.
    </li>
</ol>
<p>&nbsp;</p>
<h1 style="margin-left: 35%"><strong>PATENT PROTECTION AGREEMENT</strong></h1>
...
<p style="margin-left: 25%">
    <img src="<?php echo e(isset($plans) && $plans[0] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 1 &nbsp;
    <img src="<?php echo e(isset($plans) && $plans[1] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 2 &nbsp;
    <img src="<?php echo e(isset($plans) && $plans[2] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 3 &nbsp;
    <img src="<?php echo e(isset($plans) && $plans[3] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 4 &nbsp;
</p>
<h1><strong>CHECK PACKAGES:</strong></h1>
<p style="margin-left: 25%">
    <img src="<?php echo e(isset($plans) && $plans[4] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PKG A &nbsp;
    <img src="<?php echo e(isset($plans) && $plans[5] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> TM & CR ADD ON &nbsp;
</p>

<br><br>
<h1 style="margin-left: 30%"><strong>INVENTOR APPROVAL AND ACCEPTANCE</strong></h1>
<br><br>
...
<ol class="pSmall" type="I">
    ...
    <p>&nbsp;</p>
    <li>
        All items under the Full Payment Service Schedule and Half Payment Service Schedule are measured in approximate time frames.  The times frames may vary based on Patent Services USA, Inc.'s contractor and/or sub-contractor workloads and schedules, as well as, circumstances beyond the control of Patent Services USA, Inc., including the referred independent registered patent attorneys or independent patent agents, USPTO and/or the European Patent Office (hereinafter "EPO").
    </li>
    <p>&nbsp;</p>
    <li>
