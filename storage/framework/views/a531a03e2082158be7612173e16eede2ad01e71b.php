<link href="<?php echo e(asset('/css/pdf.css')); ?>" rel="stylesheet" xmlns="http://www.w3.org/1999/html">

    <!--page 1-->
    <p class="iconMargin">
        <img src="<?php echo e(asset('/img/logo.png')); ?>" alt="" name="Object1" width="200" height="150" id="Object1" align="center">
        <br><i style="font-size: 14px;color: darkblue;">Giving the edge to Inventors!</i>
    </p>
<h1 style="margin-left: 35%"><strong>INVENTION MARKETING GUIDE</strong></h1>
...
<p class="pSmall">
    ...
    the day of <span class="subTitle"><?php echo e(((isset($project) && ($project->getProjectProduction() != null)))?date("F jS\, Y",strtotime($project->getProjectProduction()->shippingDate)):date("F jS\, Y")); ?></span>
     ("Effective Date") by and between <strong>PATENT SERVICES USA, INC.</strong>, a Florida Corporation
    (hereinafter, the "Patent Services USA, Inc.") and <span class="subTitle"><?php echo e(isset($project)?$project->lead->fname." ".$project->lead->lname:"Client's Name"); ?></span>
    an Individual (hereinafter, the "INVENTOR").
</p>
<p class="subTitle iconMargin" align="center"><strong>TERMS OF AGREEMENT</strong></p>
<p class="pSmall">
    INVENTOR represents that he is the inventor and further represents that he is the exclusive owner of all rights, titles and interests to said invention, the <span class="subTitle"><?php echo e(isset($project)?$project->ideaName:"INVENTION NAME"); ?></span> (hereinafter, "Invention"); and
</p>
<p class="pSmall">
...
<ol class="pSmall">
    <li>
        ...
        <ol class="pSmall" type="none">
            <li>
                <strong>1.1 Various Patent Protection Services.</strong> Patent Services USA, Inc. provides two (2) Patent Protection Plans which are particularly described in Section 3. INVENTOR agrees and acknowledges Patent Services USA, Inc. has provided all necessary disclosures to the INVENTOR as provided under 35 U.S.C. 297 (a) in the Invention Marketing Guide Agreement which has been previously executed by INVENTOR.
            </li>
        </ol>
    </li>
    <li>
        <strong>Term.</strong> The initial term of this Agreement (the "Initial Term") shall commence on the Effective Date and shall continue for a period of twelve (12) months unless terminated earlier or extended as provided herein.
    </li>
    <li>
        <strong>Plan Fee.</strong> INVENTOR hereby agrees to make payments to Patent Services USA, Inc. as indicated in Section 3 in accordance with the plan selected by the INVENTOR in Section 3.  All Payments will be made in U.S. Dollars and shall be due upon signing of this Agreement. The provisions of Exhibit A, relating to payment services and schedule, shall be incorporated herein by reference and the services to be rendered by Patent Services USA, Inc. shall be offered in accordance with the provisions of Exhibit A and plan selected by the INVENTOR in Section 3. If there is any conflict in connection with the services to be rendered by Patent Services USA, Inc. as stated in Section 3 and Exhibit A, then the provisions of Exhibit A shall control.
    </li>
    <br><br><br><br>
    <table width="99%">
        <tr>
            <td class="footPage">File No.: <?php echo e(isset($project)?$project->lead->fileno:'000000'); ?></td>
            <td class="textRight"><span class="footPage">Inventor(s) Initial:</span></span> <span style="text-decoration: underline;"><?php echo e(isset($project)?strtoupper($project->lead->fname[0].$project->lead->lname[0]):''); ?></span></td>
        </tr>
    </table>
    ...
    <ol class="pSmall" type="none">
        <li>
            ...
            <ol class="pSmall" type="none">
                <li>
                    <strong>3.1.1. PLAN 1 – UNITED STATES PROVISIONAL PATENT APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $ 5,975</strong>
                    <ol class="pSmall" type="none">
                        <li>
                            <strong>3.1.1.1.</strong> Patent Services USA, Inc. will facilitate and coordinate the documentation and filing of United States <strong>Provisional Patent Application</strong> process, by working with the INVENTOR and independent registered patent attorney and/or independent patent agent regarding the patent application process. Patent Services USA, Inc. shall pay the United States Provisional Patent Application filing fee.
                        </li>
                        <li>
                            <strong>3.1.1.2.</strong> <strong>Independent Registered Attorney Patent Search & Legal Opinion.</strong>
                        </li>
                        <li>
                            <strong>3.1.1.3.</strong> Patent Services USA, Inc. shall use best efforts to engage an Independent Licensing Affiliate (hereinafter "ILA") to schedule six (6) to eight (8) national and/or international invention trade shows, every twelve (12) months; for a period of one (1) year attended by ILA as explained in Exhibit B of this Agreement, which is incorporated herein by reference.
                        </li>
                        <li>
                            <strong>3.1.1.4.</strong> The INVENTOR's invention shall be posted on the website(s) of the ILA for a period of one (1) year, at the sole discretion of the ILA.
                        </li>
                        <li>
                            <strong>3.1.1.5.</strong> Patent Services USA, Inc. shall engage a Computer Animation Specialist who will design <strong>a three-dimensional animated prototype</strong> for the INVENTOR's invention. The illustration will be used by the ILA in connection with rendering the services of ILA as explained in Exhibit A of this Agreement.
                        </li>
                        <li>
                            <strong>3.1.1.6.</strong> Upon initial submission of invention to Patent Services USA, Inc., Patent Services USA, Inc.'s experienced product review team shall review INVENTOR's invention. Throughout the term of this Agreement, Patent Services USA, Inc. shall provide customer service support to INVENTOR in connection with the progress of its services as stated herein.
                        </li>
                    </ol>
                </li>
                <li>
                    <strong>3.1.2. PLAN 2 - UNITED STATES COPYRIGHT APPLICATION PROGRAM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $ 995</strong>
                    <ol class="pSmall" type="none">
                        <li>
                            <strong>3.1.2.1.</strong> Patent Services USA, Inc. will facilitate and coordinate the documentation relating to copyright search by working with the INVENTOR and an independent attorney.
                        </li>
                        <li>
                            <strong>3.1.2.2.</strong> Based on the results of the copyright search and upon INVENTOR's approval, Patent Services USA, Inc. will facilitate and coordinate the documentation relating to copyright application with the INVENTOR and an independent attorney.
                        </li>
                        <li>
                            <strong>3.1.2.3.</strong> Throughout the term of this Agreement, Patent Services USA, Inc. shall provide customer service support to INVENTOR in connection with the progress of its services as stated herein.
                        </li>
                    </ol>
                </li>
            </ol>
    ...
    <li>
        ...
        <ol class="pSmall" type="none">
            ...
            <li>
                <strong>9.4.</strong> Patent Services USA, Inc. is not a law firm and does not provide legal advice or legal opinion. Patent Services USA, Inc. shall engage independent registered patent attorneys and/or patent agents to assist in certain matters relating to the services described herein. In the event that the INVENTOR upgrades to the nonprovisional patent application as described in exhibit A, these patent services will include up to three (3) actions in an attempt to resolve patent application modifications or rejections through USPTO and/or any patent examiner as deemed necessary by an independent registered patent attorney.  Any further actions required in connection with the Invention other than those stated in Section 9.4 shall be the sole responsibility of the INVENTOR.
            </li>
            <li>
    ...
    <li>
        <strong>Notices.</strong> Any notice, waiver, demand or other communication required or permitted by this Agreement must be in writing and shall be deemed to have been received when delivered to Patent Services USA, Inc.'s place of business. If delivered by messenger, when sent, or; if mailed, on the third business day after deposit in the United States mail, certified or registered postage prepaid, return receipt requested, or, if faxed, telexed, or telegraphed, six (6) hours after being dispatched by fax, telegram, or telex; or if emailed, next business day after the day when the email was sent, in every case addressed to the party to be notified as follows:
        ...
        <table width="75%">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <?php echo e(isset($project)?$project->lead->fname." ".$project->lead->lname:"Client's Name"); ?><br>
                    <?php echo e(isset($project)?$project->lead->street:""); ?><br>
                    <?php echo e(isset($project)?$project->lead->street2:""); ?><br>
                    <?php echo e(isset($project)?$project->lead->phone:""); ?><br>
                    <?php echo e(isset($project)?$project->lead->email:""); ?>
    ...
    <li>
        ...
        <ol class="pSmall" type="none">
            ...
            <li>
                <strong>17.2.</strong> "Invention(s)" mean the product concept described in the Invention Marketing Guide previously received by the INVENTOR.
            </li>
            <li>
    ...
    <li>
        ...
        <ol class="pSmall" type="none">
            ...
            <li>
                <strong>18.2.</strong> In the event that said dispute is not resolved in mediation, the parties shall submit the dispute to a neutral arbitrator residing in Miami-Dade County, Florida. The arbitration shall be held in Miami-Dade County, Florida. In the event that the parties are unable to agree upon an arbitrator within fifteen (15) days of the date on which either party requests arbitration of a matter, the arbitrator shall be provided by the American Arbitration Association. The prevailing party shall recover all fees and costs of said arbitration. The parties further agree that full discovery shall be allowed to each party to the arbitration and a written award shall be entered forthwith. Any and all types of relief that would otherwise be available in Court shall be available to both parties in the arbitration. The decision of the arbitrator shall be final and binding.  Arbitration shall be the exclusive legal remedy of the parties. Judgment upon the award may be entered in any court of competent jurisdiction.
            </li>
            <li>
...
<p style="margin-left: 25%">
    <img src="<?php echo e($plans[0] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 1 &nbsp;
    <img src="<?php echo e($plans[1] == 'true' ?asset('/img/chk_square.png'):asset('/img/unchk_square.png')); ?>" alt=""> PLAN 2 &nbsp;
</p>
...
<table width="100%">
    <tr>
        <?php if(isset($inventor_name)): ?>

            <td>By:</td>              <td style="text-decoration: underline;"> <?php echo e(isset($inventor_name)?$inventor_name:''); ?></td>                  <td>Date: </td>                   <td style="text-decoration: underline;"> <?php echo e(isset($inventor_date)?$inventor_date:''); ?></td>
    ...
    <tr>
        <td>By:</td>              <td> <img style="position: absolute;top: -20px !important;" src="<?php echo e(asset('/img/leslieSignature.png')); ?>"><br><p style="margin-top: 0px !important;z-index: 100;">_____________________________________</p></td>                  <td>Date: </td>                   <td style="text-decoration: underline;">_____________<?php echo e(date("m-d-Y")); ?>_______________</td>
    </tr>
    <tr>
...
<ol class="pSmall" type="I">
    <li>
        <strong class="subTitle">Provisional Patent Protection Payment Service Schedule:</strong>
        <br><br>
        <ol class="pSmall" type="A">
            <li>
                Invention Marketing Welcome Package confirming the opening of the INVENTOR'S file is mailed within thirty (30) days after the payment is received by Patent Services USA, Inc.
            </li>
            <li>
                Quality Assurance Questionnaire is mailed to the INVENTOR in the above mentioned Invention Marketing Welcome Package.
            </li>
            <li>
            ...
            <li>
                All documentation relating to the patent search received from the independent registered patent attorney will be forwarded to the INVENTOR by Patent Services USA, INC. These results are provided to the INVENTOR approximately forty-five (45) days after signing this agreement.
            </li>
            <li>
                Patent Services USA, Inc. shall engage a Computer Animation Specialist who will <strong>design a three-dimensional animated prototype</strong> for the INVENTOR's invention.
            </li>
            <li>
				The INVENTOR may upgrade from Provisional Patent to Full Nonprovisional (Utility) Patent protection within twelve (12) months of signing this Agreement contingent upon favorable patent search with legal opinion.  An additional patent application program charge of $5,975.00 and an administration fee of $849.00 shall apply in order to initiate this upgrade.
            </li>
        </ol>
    </li>
    <br><br>
    <li>
        <strong class="subTitle">Upgrade to Full Nonprovisional Patent Protection Payment Service Schedule:</strong>
        <br><br>
        <ol class="pSmall" type="A" start="9">
            <li>
                All services as listed above in Provisional Patent Protection Payment Service Schedule.
            </li>
            <li>
                A Trademark search (if applicable) will be performed by independent attorneys and shall be provided to the INVENTOR approximately ninety (90) days after full payment is received by Patent Services USA, Inc.
            </li>
            <li>
                Patent Services USA, Inc. shall compile all documents for the INVENTOR and send those documents to the independent registered patent attorney or independent patent agent (if applicable). These documents are completed approximately ninety (90) days after the INVENTOR officially upgrades to the full Nonprovisional (Utility) Patent as stated above in Section I.
            </li>
            <li>
                A Trademark Application is prepared (if applicable). This service will be provided to the INVENTOR approximately ninety (90) days after the services listed above in Section II (K) are completed.
            </li>
            <li>
            ...
            <li>
                European Union Community Design Patent Application will begin immediately after a full Nonprovisional United States Patent Application is filed and a "filing receipt" is received from the United States Patent and Trademark Office (hereinafter "USPTO").  The filing receipt shall be provided to the INVENTOR (if applicable).
            </li>
        </ol>
    </li>
    <p>&nbsp;</p>
    <li>
        All items under the Provisional Patent Protection Payment Service Schedule and Full Nonprovisional Patent Protection Payment Service Schedule are measured in approximate time frames.  The times frames may vary based on Patent Services USA, Inc.'s contractor and/or sub-contractor workloads and schedules, as well as, circumstances beyond the control of Patent Services USA, Inc., including the referred independent registered patent attorneys or independent patent agents, USPTO and/or the European Patent Office (hereinafter "EPO").
    </li>
    <p>&nbsp;</p>
    <li>
...
<ol class="pSmall" type="A">
    ...
    <p>&nbsp;</p>
    <li>
        Patent Services USA, Inc. will make a diligent effort to notify INVENTOR, within a reasonable and timely manner, as to any expressed interest in an idea, from any industry manufacturing representatives, their agents or any other industry organization or professional, through any appropriate verbal or written communication.  Patent Services USA, Inc. will make a diligent effort to guide the INVENTOR on how to continue the communication to any interested manufacturing representative, their agents or any other industry organization or professional, in accordance with the standards set in the "Invention Marketing Guide" prepared for the INVENTOR prior to being referred to the ILA.
    </li>
    <p>&nbsp;</p>
    <li>
    ...
    <p>&nbsp;</p>
    <li>
        Trade show representation through the ILA will remain in effect for a period of one (1) year from the Effective Date of the Agreement.
    </li>
</ol>
