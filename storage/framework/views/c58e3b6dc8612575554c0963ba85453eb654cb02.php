...
<html lang="en">
    <head>
        ...
        <?php echo $__env->yieldContent('metainfo'); ?>
                ...
                <div class="container" style="">
                    <ul class="main-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(url('learn/Welcome-to-Our-Learning-Center')); ?>">Learning Center</a></li>
                                <li><a href="<?php echo e(url('about-us#Portfolio')); ?>">About Us</a></li>
                                <li><a href="<?php echo e(url('faq#Portfolio')); ?>">FAQ</a></li>
                                <li><a href="<?php echo e(url('download-page#Portfolio')); ?>">Downloads</a></li>
                            </ul>
                        </li>
                        <li><a href="<?php echo e(url('trade-shows#Portfolio')); ?>">Trade Shows</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(url('learn/Industry-Expert-Radio-Segment-1')); ?>">Radio</a></li>
                            </ul>
                        </li>
    ...
    <?php echo $__env->make('omi.land.tools.submitRequestModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <span class="footer-terms-links"><a href="<?php echo e(url('terms-and-conditions#Portfolio')); ?>">Terms and Conditions</a><a href="<?php echo e(url('privacy#Portfolio')); ?>">Privacy</a><a href="<?php echo e(url('legal#Portfolio')); ?>">Legal</a></span>
        </div>
    </footer>
