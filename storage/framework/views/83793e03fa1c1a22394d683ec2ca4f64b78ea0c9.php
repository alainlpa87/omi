                ...
                <tr>
                    <td style="border-bottom: 1px solid black;border-right: 1px solid black;" colspan="4">
                        ...
                        <div class="col-md-9 pull-right">
                            <div class="sigPad sign-add-d" id="signt_s_add_<?php echo e($i); ?>"  style="padding-top: 5px;">
                                <div class="sig sigWrapper current">
                                    <canvas class="pad" width="290" height="50"></canvas>
                                    <input type="hidden" name="output<?php echo e($i); ?>" class="output">
                                </div>
                                <ul class="sigNav">
                ...
                <tr>
                    <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            Residence: City
                            <input type="text" name="residence_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                    <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            State
                            <input type="text" name="state_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                    <td colspan="2" style="border-bottom: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            Country
                            <input type="text" name="country_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="border-bottom: 1px solid black;" colspan="5">
                        <p style="font-size: 13px; padding-bottom: 0px;margin-bottom: 0px;margin-left: 0px;padding-left: 0px">
                            Mailing Address
                            <input type="text" name="mAddress_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            City
                            <input type="text" name="city_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                    <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            State
                            <input type="text" name="state1_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                    <td colspan="1" style="border-bottom: 1px solid black;border-right: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            Zip
                            <input type="text" name="zip_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                    <td colspan="1" style="border-bottom: 1px solid black;">
                        <p style="font-size: 13px;padding-left: 0px;margin-left: 0px;padding-bottom: 0px;margin-bottom: 0px;">
                            Country
                            <input type="text" name="country1_<?php echo e($i); ?>" class="form-control">
                        </p>
                    </td>
                </tr>
            <?php endfor; ?>
