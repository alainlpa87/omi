...
<ul class="circle">
    <table width="85%">
        ...
        <tr>
            ...
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 20px" alt=""> <strong>&nbsp; $879</strong></td>
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 20px" alt=""> <strong>&nbsp; $1,079</strong></td>
            <td width="12%"><img src="<?php echo e(asset('/img/unchk_square.png')); ?>" style="margin-left: 30%" alt=""> <strong>&nbsp; $1,379</strong></td>
        </tr>
    </table>
</ul>
...
<table class="notesTable">
    <tr>
        <td class="red"><img src="<?php echo e(asset('/img/contracts/unchk_square.png')); ?>" alt="">  ALL INFORMATION IS CORRECT AND NO CORRECTIONS ARE NECESSARY AT THIS TIME</td>
    </tr>
</table>
...
<table cellspacing="12">
    <tr>
        <th>INVENTOR NAME: <?php echo e($project->lead->fname." ".$project->lead->lname); ?> </th>
        <th>FILE NUMBER: <?php echo e($project->lead->fileno); ?></th>
    </tr>
    <tr>
