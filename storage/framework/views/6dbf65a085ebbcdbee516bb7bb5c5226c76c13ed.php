<link href="<?php echo e(asset('/css/pdf_client.css')); ?>" rel="stylesheet" xmlns="http://www.w3.org/1999/html">
    ...
    <br>
    <p class=" pSmall">
        Title of the Work: _______________________________________________________________________________
    </p>
    <p class=" pSmall">
    ...
    <br>
    <p class=" pSmall">
        Author's Date of Birth: ___________________________________________________________________________
    </p>
    <p class=" pSmall">
        Author's Nationality: _____________________________________________________________________________
    </p>
    <p class=" pSmall">
        Citizen of: _____________________________________________________________________________________
    </p>
    <p class=" pSmall">
        Domiciled in: ___________________________________________________________________________________
    </p>
<p class=" pSmall">
...
<p class=" pSmall">______________________________________________________________________________________________</p>
<p class=" pSmall">______________________________________________________________________________________________</p>
<br><br>
...
<p>Is the Author the Claimant of the copyright? &nbsp;&nbsp;<img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt=""> &nbsp;&nbsp;<span class="pMiniSmall">(Yes, unless ownership has been transferred)</span></p>
<p class=" pSmall">Identify any pre-existing material in work:</p>
<p class=" pSmall">______________________________________________________________________________________________</p>
<p>Deposit Copy Included? &nbsp;&nbsp; <img src="<?php echo e(asset('/img/unchk_square.png')); ?>" alt="">&nbsp;&nbsp;<span class="pMiniSmall">(A copy of the work typically must be deposited with the U.S. Copyright Office)</span></p>
<br>
<p>
    <strong class=" pSmall">
