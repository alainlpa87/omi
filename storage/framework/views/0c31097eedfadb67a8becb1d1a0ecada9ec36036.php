...
<div style="border: 2px solid black;">
    ...
    <table style="width: 100% !important;border-collapse: collapse !important;">
        ...
        <tr>
            ...
            <td colspan="5" style="border-bottom: 1px solid black;"><p class="mySmall" style="text-align: left;margin-bottom: 3px !important;margin-top: 3px !important;"><b><?php echo e(ucwords($invName)); ?></b></p></td>
        </tr>
        <tr>
