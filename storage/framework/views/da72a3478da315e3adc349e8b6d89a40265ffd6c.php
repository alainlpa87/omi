...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <?php endif; ?>
                <?php if(($cS=$project->clientServicesProject())!=null && ($docsToSign>0 || ($cS->appSent_created_at!="" && $cS->patentAppApproved_created_at == "") || $upLetterSign == 1 || $ilcNeedSign == 1)): ?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <?php if(count($cS->getDocsCS())==1 && $cS->getDocsCS()[0]->notes_resend==""  && ($cS->appSent_created_at=="" || $cS->patentAppApproved_created_at == "") && $upLetterSign == -1 ): ?>
                            
                            <div id="showOnlyDoc" class="dashboard-stat dashboard-stat-light blue-soft" style="cursor:pointer;" data-doc="<?php echo e($cS->getDocsCS()[0]->document); ?>" data-pid="<?php echo e($project->id); ?>" >
                                <div class="visual">
                                    <i class="fa fa-pencil"></i>
                                </div>
                                <div class="details" style="right: 0 !important;">
                                    <div class="number">
                                        <p style="font-size: 80%;">SIGN <?php echo e($cS->getDocsCS()[0]->name); ?></p>
                                    </div>
                                </div>
                            </div>
                ...
                <?php if($allowPayment): ?>
                    <?php if($contract->funding==1||($contract->type=="PPA" && strlen($contract->signed)>0)): ?>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <form method="POST" action="<?php echo e(url("payment_sandbox")); ?>" id="paymentForm">
                    ...
                    <?php else: ?>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-light green-soft" href="<?php echo e(route('launch_sandbox/signBeforePaid',$project->id)); ?>">
                                <div class="visual"><i class="fa fa-money"></i></div>
                                <div class="details">
                                    <div class="number">
                                        Make a Payment
                    ...
                    <div class="tab-content col-md-12">
                        ...
                        <div class="tab-pane" id="portlet_tab_2"  role="tabpanel">
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input type="text" id="coInventor" class="form-control" value="<?php echo e($project->coInventor); ?>">
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
 ...
 Your patent was filed on <?php echo e(date('m/d/Y',strtotime($pcs->patentAppFiled_created_at))); ?> -Application number is <?php echo e($pcs->patentAppNo); ?>"></i>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 " id="fileList_<?php echo e($project->id); ?>">
                ...
                <?php $__currentLoopData = $project->filesByType(array('public')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-12 col-sm-12 col-xs-12" id="divFile_<?php echo e($file->id); ?>"><span title="<?php echo e($file->fileName); ?>&nbsp;&nbsp;&nbsp;<?php echo e($file->created_at); ?>"><a href="<?php echo e(asset("/".$file->url)); ?>" target="_blank"><?php echo e(strlen($file->fileName)>25?substr($file->fileName,0,23).'...':$file->fileName); ?></a></span><span title="Delete File" data-id="<?php echo e($file->id); ?>" class="launchDeleteFile"><i class="fa fa-times "></i></span></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
