<div class="col-md-12  divContract">
    <form method="post" action="<?php echo e(url('launch/clientServices/createDocusignCSDocs')); ?>" name="formSign"  id="formSign" >
        ...
        <p>
            This Agreement for Patent Services (the "Agreement") is entered into by and between <u>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($attorney->fname." ".$attorney->lname); ?>  &nbsp;&nbsp;&nbsp;&nbsp;</u> (“PATENT FIRM”) and <strong><u class="verySmall"><?php echo e(ucwords($client->fname." ".$client->lname)); ?></u>
                <?php if(strlen($project->coInventor)!=0): ?>
                    and <u><?php echo e($project->coInventor); ?></u>
                <?php endif; ?>
            </strong> residing at the address of <strong><u><?php echo e(isset($client->street)?$client->street." ".$client->street2:"address"); ?></u></strong> ("INVENTOR").  By executing this
        ...
        <p>Should the USPTO venue, judgment, or decision that no action will be taken be found to be unenforceable as a matter of
            ...
            good faith, settle the dispute through mediation in <?php echo e($attorney->location); ?> conducted by a mediator to be mutually selected. The
        ...
        <p>All disputes, claims, or controversies arising out of or relating to this Agreement, or any other agreement executed and delivered
            ...
            arbitration shall be held in <?php echo e($attorney->location); ?> before a single arbitrator and shall be conducted in accordance with the
            ...
            by the provisions of the <?php echo e(explode(',',$attorney->location)[1]); ?> Arbitration Act, <?php echo e(explode(',',$attorney->location)[1]); ?> Code of Civil Procedure sections 1280 1294.2. The parties covenant
        ...
        <p>The validity, interpretation, and performance of this Agreement will be controlled and construed in all respects under the
            laws of the United States of America and by the laws of the State of <?php echo e(explode(',',$attorney->location)[1]); ?>.
        </p>
